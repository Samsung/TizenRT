...
#endif
	{
		berr("ERROR: Entry point is not properly aligned: %08\n",
			 ehdr->e_entry);
		return false;
	}
	...
	case R_ARM_JUMP24:
		{
			...
			{
				berr("ERROR: PC24 [%d] relocation out of range, "
					"offset=%08lx\n",
...
#if defined(CONFIG_ARMV7A_TARGET2_PREL)
