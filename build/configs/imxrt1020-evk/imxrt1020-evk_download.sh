...
function imxrt1020_dwld_help()
{
	...
	OPTIONS:
		ALL or [any partition name in .config file case sensitive]
	...
	For examples:
        ...
        ALL             write All paritions with corresponding Binaries
        kernel          write Kernel partition with corresponding Binary
        kernel  app     write Kerel and app partition with corresponding Binaries
EOF
}
