from bkutils.protocol.bootrom.v2_0 import FlashWrite4kExtProtocol
import unittest


class TestFlashWrite4kExtProtocol(unittest.TestCase):

    def setUp(self):
        self.protocol = FlashWrite4kExtProtocol()
