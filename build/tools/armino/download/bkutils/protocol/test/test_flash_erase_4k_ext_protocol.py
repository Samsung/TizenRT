from bkutils.protocol.bootrom.v2_0 import FlashErase4kExtProtocol
import unittest


class TestFlashErase4kExtProtocol(unittest.TestCase):

    def setUp(self):
        self.protocol = FlashErase4kExtProtocol()
