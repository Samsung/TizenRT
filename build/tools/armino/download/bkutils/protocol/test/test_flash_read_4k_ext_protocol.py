from bkutils.protocol.bootrom.v2_0 import FlashRead4kExtProtocol
import unittest


class TestFlashRead4kExtProtocol(unittest.TestCase):

    def setUp(self):
        self.protocol = FlashRead4kExtProtocol()
