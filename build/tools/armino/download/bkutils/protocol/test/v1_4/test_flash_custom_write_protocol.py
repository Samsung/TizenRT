from bkutils.protocol.bootrom.v2_0.v1_4 import FlashCustomWriteProtocol
import unittest


class TestFlashCustomWriteProtocol(unittest.TestCase):

    def setUp(self):
        self.protocol = FlashCustomWriteProtocol()
