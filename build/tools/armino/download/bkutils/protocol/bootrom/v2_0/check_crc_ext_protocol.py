...
class CheckCrcExtProtocol(BaseBootRomProtocol):
    ...
    def cmd(self, start_addr, end_addr):
        return self.command_generate(0x13, [start_addr&0xff, (start_addr>>8)&0xff, (start_addr>>16)&0xff, (start_addr>>24)&0xff, end_addr&0xff, (end_addr>>8)&0xff, (end_addr>>16)&0xff, (end_addr>>24)&0xff])
