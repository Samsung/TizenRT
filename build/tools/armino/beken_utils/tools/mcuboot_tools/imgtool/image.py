...
class Image():
    ...
    def get_public_bytes_from_pubkeyfile(self, pubkey_file):
        ...
        try:
            ...
            print(f'mcuboot failed to load PEM data {e}')
            exit(1)

    def save_bin_hash(self, hash, outfile):
        data = {'hash':''}
        data['hash'] = hash

        print(f'mcuboot save bin hash, hash_value={hash}')
    ...
    def create(self, key, public_key_format, enckey, dependencies=None,
        ...
        if key is not None:
            ...
            pub = self.get_public_bytes_from_pubkeyfile(pubkeyfile)
    ...
    def add_header(self, enckey, protected_tlv_size, aes_length=128):
        ...
        self.payload[16:16 + len(header)] = header
