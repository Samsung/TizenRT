...
int tc_containers_unord_unord_multimap_unord_multimap_cnstr_move_alloc(void) {
    {
        ...
        TC_ASSERT_EXPR((c.get_allocator() == test_allocator<std::pair<const int, std::string> >(12)));
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(c.hash_function() == test_hash<int>(8));
        TC_ASSERT_EXPR(c.key_eq() == test_equal_to<int>(9));
        TC_ASSERT_EXPR((c.get_allocator() == test_allocator<std::pair<const int, std::string> >(10)));
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(c.hash_function() == test_hash<int>(8));
        TC_ASSERT_EXPR(c.key_eq() == test_equal_to<int>(9));
        TC_ASSERT_EXPR((c.get_allocator() == min_allocator<std::pair<const int, std::string> >()));
