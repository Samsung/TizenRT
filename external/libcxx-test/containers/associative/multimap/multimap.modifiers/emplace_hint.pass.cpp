...
int tc_containers_associative_multimap_multimap_modifiers_emplace_hint(void) {
    {
        ...
        TC_ASSERT_EXPR(std::next(m.begin())->second == DefaultOnly());
        ...
        TC_ASSERT_EXPR(std::next(m.begin(), 2)->second == DefaultOnly());
