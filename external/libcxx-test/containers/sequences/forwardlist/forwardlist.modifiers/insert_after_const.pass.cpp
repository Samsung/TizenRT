...
int tc_containers_sequences_forwardlist_forwardlist_modifiers_insert_after_const(void) {
    {
        typedef int T;
        ...
        TC_ASSERT_EXPR(c.front() == 0);
        TC_ASSERT_EXPR(*std::next(c.begin()) == 1);
        ...
        TC_ASSERT_EXPR(*std::next(c.begin(), 2) == 1);
        TC_ASSERT_EXPR(*std::next(c.begin(), 3) == 2);
