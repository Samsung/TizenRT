...
int tc_containers_sequences_list_list_ops_splice_pos_list_iter(void) {
    int a1[] = {1, 2, 3};
    int a2[] = {4, 5, 6};
    {
        std::list<int> l1;
        ...
        TC_ASSERT_EXPR(std::distance(l2.begin(), l2.end()) == 0);
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(std::distance(l2.begin(), l2.end()) == 1);
        std::list<int>::const_iterator i = l1.begin();
        TC_ASSERT_EXPR(*i == 4);
        i = l2.begin();
        TC_ASSERT_EXPR(*i == 5);
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(std::distance(l2.begin(), l2.end()) == 2);
        std::list<int>::const_iterator i = l1.begin();
        TC_ASSERT_EXPR(*i == 4);
        i = l2.begin();
        TC_ASSERT_EXPR(*i == 5);
