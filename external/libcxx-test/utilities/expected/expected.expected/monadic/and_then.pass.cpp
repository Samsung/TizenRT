...
constexpr void test_val_types() {
  // Test & overload
  {
    // Without &qualifier on F'soperator()
    {
      ...
      TC_ASSERT_EXPR(e.and_then(UnexpectedLVal{}).error() == 5);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      TC_ASSERT_EXPR(e.and_then(nl).error() == 5);
    }
  }
  ...
  // Test const& overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      TC_ASSERT_EXPR(val == 1);
      TC_ASSERT_EXPR(e.and_then(UnexpectedCLVal{}).error() == 5);
    }
  ...
  // Test && overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      TC_ASSERT_EXPR(val == 1);
      TC_ASSERT_EXPR(std::move(e).and_then(UnexpectedRVal{}).error() == 5);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      TC_ASSERT_EXPR(val == 1);
      TC_ASSERT_EXPR(e.and_then(UnexpectedRVRefQual{}).error() == 5);
    }
  }
  ...
  // Test const&& overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      TC_ASSERT_EXPR(val == 1);
      TC_ASSERT_EXPR(std::move(e).and_then(UnexpectedCRVal{}).error() == 5);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      TC_ASSERT_EXPR(std::move(e).and_then(std::move(nl)).error() == 5);
    }
  }
}
// clang-format on
...
int tc_utilities_expected_expected_expected_monadic_and_then(void) {
  test();
  static_assert(test());
