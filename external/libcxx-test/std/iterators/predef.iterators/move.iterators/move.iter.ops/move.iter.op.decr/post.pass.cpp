...
{
    char s[] = "123";
    TC_ASSERT_FUNC((test(bidirectional_iterator<char*>(s+1), bidirectional_iterator<char*>(s))));
    TC_ASSERT_FUNC((test(random_access_iterator<char*>(s+1), random_access_iterator<char*>(s))));
