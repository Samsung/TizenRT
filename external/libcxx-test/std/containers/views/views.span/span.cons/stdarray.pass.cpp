...
int tc_containers_views_views_span_span_cons_stdarray(void) {
    TC_ASSERT_EXPR(testConstructors<int>());
    TC_ASSERT_EXPR(testConstructors<long>());
    TC_ASSERT_EXPR(testConstructors<double>());
    TC_ASSERT_EXPR(testConstructors<A>());

    TC_ASSERT_EXPR(testConstructors<int*>());
    TC_ASSERT_EXPR(testConstructors<const int*>());
