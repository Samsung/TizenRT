...
int tc_containers_container_adaptors_stack_stack_cons_deduct(void) {
...
//  Test the explicit deduction guides
    ...
    TC_ASSERT_EXPR(stk.size() == v.size());
    TC_ASSERT_EXPR(stk.top() == v.back());
    }
    ...
    TC_ASSERT_EXPR(stk.size() == 10);
    TC_ASSERT_EXPR(stk.top() == 19);
