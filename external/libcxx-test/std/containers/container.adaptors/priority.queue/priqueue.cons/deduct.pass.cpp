...
int tc_containers_container_adaptors_priority_queue_priqueue_cons_deduct(void) {
...
//  Test the explicit deduction guides
    ...
    TC_ASSERT_EXPR(pri.size() == v.size());
    TC_ASSERT_EXPR(pri.top() == 0);
    }
