...
int tc_containers_container_adaptors_queue_queue_cons_deduct(void) {
...
//  Test the explicit deduction guides
    ...
    TC_ASSERT_EXPR(que.size() == l.size());
    TC_ASSERT_EXPR(que.back() == l.back());
    }
    ...
    TC_ASSERT_EXPR(que.size() == 10);
    TC_ASSERT_EXPR(que.back() == 19);
