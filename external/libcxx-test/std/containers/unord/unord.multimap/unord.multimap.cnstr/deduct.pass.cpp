...
int tc_containers_unord_unord_multimap_unord_multimap_cnstr_deduct(void) {
    ...
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    }
    ...
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 41);
    }
    ...
    ASSERT_SAME_TYPE(decltype(m), decltype(source));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 42);
    TC_ASSERT_EXPR(m.size() == 0);
    }
    ...
    ASSERT_SAME_TYPE(decltype(m), decltype(source));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 43);
    TC_ASSERT_EXPR(m.size() == 0);
    }
    ...
    ASSERT_SAME_TYPE(decltype(m), std::unordered_multimap<int, long, std::hash<short>, std::equal_to<>, test_allocator<PC>>);
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 44);
    }
    ...
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 45);
    }
    ...
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 46);
    }
    ...
    ASSERT_SAME_TYPE(decltype(m), std::unordered_multimap<int, long, std::hash<int>, std::equal_to<int>, test_allocator<PC>>);
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 47);
    }
    ...
    ASSERT_SAME_TYPE(decltype(m), std::unordered_multimap<int, long, std::hash<short>, std::equal_to<int>, test_allocator<PC>>);
    TC_ASSERT_EXPR(std::is_permutation(m.begin(), m.end(), std::begin(expected_m), std::end(expected_m)));
    TC_ASSERT_EXPR(m.get_allocator().get_id() == 48);
    }
