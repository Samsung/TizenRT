...
void test(Container& c)
{
    ...
    for (int i = 0; i != 10; ++i)
    {
        ...
        TC_ASSERT_EXPR(it->first == i && it->second == i + 1);
    }
    ...
    { // Insert duplicate node.
        ...
        TC_ASSERT_EXPR(it != c.end() && it->second == 42);
    }
...
int tc_containers_unord_unord_multimap_unord_multimap_modifiers_insert_node_type(void) {
