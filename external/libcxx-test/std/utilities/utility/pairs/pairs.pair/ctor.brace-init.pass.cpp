...
TEST_CONSTEXPR_CXX14 bool test() {
    ...
    // Implicit constructor
    {
        ...
        TC_ASSERT_EXPR(p.first.value == 42);
    }
    {
    ...
    {
        TC_ASSERT_EXPR(explicit_vs_implicit_brace_init({{}, {}}) == 2);
    }

    return true;
}

int tc_utilities_utility_pairs_pairs_pair_ctor_brace_init(void) {
    test();
#if TEST_STD_VER > 11
    static_assert(test(), "");
#endif
