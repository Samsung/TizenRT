...
int tc_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_reuse_blocks(void) {
  ...
  TC_ASSERT_EXPR(is_aligned_to(ret, 8));
  ...
  r1.deallocate(ret, 8);
  TC_ASSERT_EXPR(globalMemCounter.new_called == new_called);
