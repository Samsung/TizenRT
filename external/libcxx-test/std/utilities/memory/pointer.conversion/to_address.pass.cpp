...
constexpr bool test() {
    ...
    TC_ASSERT_EXPR(std::to_address(&i) == &i);
    P1 p1(&i);
    ASSERT_NOEXCEPT(std::to_address(p1));
    TC_ASSERT_EXPR(std::to_address(p1) == &i);
    P2 p2(&i);
    ASSERT_NOEXCEPT(std::to_address(p2));
    TC_ASSERT_EXPR(std::to_address(p2) == &i);
    P3 p3(&i);
    ASSERT_NOEXCEPT(std::to_address(p3));
    TC_ASSERT_EXPR(std::to_address(p3) == &i);
    P4 p4(&i);
    ASSERT_NOEXCEPT(std::to_address(p4));
    TC_ASSERT_EXPR(std::to_address(p4) == &i);
    ...
    TC_ASSERT_EXPR(std::to_address(p7) == nullptr);
