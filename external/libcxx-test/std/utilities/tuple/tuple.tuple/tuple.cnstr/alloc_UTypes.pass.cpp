...
int tc_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_UTypes(void) {
    {
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(std::get<0>(t).value == 42);
        TC_ASSERT_EXPR(std::get<1>(t).value == 43);
    }
    {
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(std::get<0>(t).value == 1);
        TC_ASSERT_EXPR(std::get<1>(t).value == 2);
        TC_ASSERT_EXPR(std::get<2>(t).value == 3);
    }
    {
