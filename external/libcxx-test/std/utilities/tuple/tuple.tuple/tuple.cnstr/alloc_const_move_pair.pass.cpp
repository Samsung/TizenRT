...
constexpr bool test() {
  // test implicit conversions.
  {
    ...
    TC_ASSERT_EXPR(std::get<0>(t).alloc_constructed);
    TC_ASSERT_EXPR(std::get<1>(t).alloc_constructed);
  }
...
int tc_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_move_pair(void) {
  test();
  static_assert(test());
