...
int tc_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor(void) {
    ...
    { // rvalue reference
        ...
        TC_ASSERT_EXPR(&std::get<0>(t2) == &t1);
    }
    { // const lvalue reference
        ...
        TC_ASSERT_EXPR(&std::get<0>(t3) == &t1);
    }
    { // lvalue reference
        T t1(42);
    ...
    // 'tuple<T>'.
    {
        ...
        std::tuple<int> t1(42);
        std::tuple<VT> t2(t1);
        TC_ASSERT_EXPR(std::get<0>(t2).state == VT::FromTuple);
    }
    {
    ...
    // chosen and 'UDT' constructed from 'T'
    {
        ...
        std::tuple<int> t1(42);
        std::tuple<VT> t2(t1);
        TC_ASSERT_EXPR(std::get<0>(t2).state == VT::FromInt);
    }
    {
