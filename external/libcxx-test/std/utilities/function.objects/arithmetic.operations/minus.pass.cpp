...
int tc_utilities_function_objects_arithmetic_operations_minus(void) {
...
#endif
    TC_ASSERT_EXPR(f(3, 2) == 1);
#if TEST_STD_VER > 11
    typedef std::minus<> F2;
    const F2 f2 = F2();
    TC_ASSERT_EXPR(f2(3,2) == 1);
    TC_ASSERT_EXPR(f2(3.0, 2) == 1);
    TC_ASSERT_EXPR(f2(3, 2.5) == 0.5);
