...
int tc_utilities_function_objects_arithmetic_operations_modulus(void) {
...
#endif
    TC_ASSERT_EXPR(f(36, 8) == 4);
#if TEST_STD_VER > 11
    typedef std::modulus<> F2;
    const F2 f2 = F2();
    TC_ASSERT_EXPR(f2(36, 8) == 4);
    TC_ASSERT_EXPR(f2(36L, 8) == 4);
    TC_ASSERT_EXPR(f2(36, 8L) == 4);
