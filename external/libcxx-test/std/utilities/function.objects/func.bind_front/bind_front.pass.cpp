...
constexpr bool test() {
  ...
  {
    {
      ...
      TC_ASSERT_EXPR(f() == std::make_tuple());
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{});
      TC_ASSERT_EXPR(f() == std::make_tuple(Elem<1>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{}, Elem<2>{});
      TC_ASSERT_EXPR(f() == std::make_tuple(Elem<1>{}, Elem<2>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{}, Elem<2>{}, Elem<3>{});
      TC_ASSERT_EXPR(f() == std::make_tuple(Elem<1>{}, Elem<2>{}, Elem<3>{}));
    }
  }
  ...
  // Bind no arguments, call with arguments
  {
    {
      auto f = std::bind_front(MakeTuple{});
      TC_ASSERT_EXPR(f(Elem<1>{}) == std::make_tuple(Elem<1>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{});
      TC_ASSERT_EXPR(f(Elem<1>{}, Elem<2>{}) == std::make_tuple(Elem<1>{}, Elem<2>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{});
      TC_ASSERT_EXPR(f(Elem<1>{}, Elem<2>{}, Elem<3>{}) == std::make_tuple(Elem<1>{}, Elem<2>{}, Elem<3>{}));
    }
  }
  ...
  // Bind arguments, call with arguments
  {
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{});
      TC_ASSERT_EXPR(f(Elem<10>{}) == std::make_tuple(Elem<1>{}, Elem<10>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{}, Elem<2>{});
      TC_ASSERT_EXPR(f(Elem<10>{}) == std::make_tuple(Elem<1>{}, Elem<2>{}, Elem<10>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{}, Elem<2>{}, Elem<3>{});
      TC_ASSERT_EXPR(f(Elem<10>{}) == std::make_tuple(Elem<1>{}, Elem<2>{}, Elem<3>{}, Elem<10>{}));
    }

    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{});
      TC_ASSERT_EXPR(f(Elem<10>{}, Elem<11>{}) == std::make_tuple(Elem<1>{}, Elem<10>{}, Elem<11>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{}, Elem<2>{});
      TC_ASSERT_EXPR(f(Elem<10>{}, Elem<11>{}) == std::make_tuple(Elem<1>{}, Elem<2>{}, Elem<10>{}, Elem<11>{}));
    }
    {
      auto f = std::bind_front(MakeTuple{}, Elem<1>{}, Elem<2>{}, Elem<3>{});
      TC_ASSERT_EXPR(f(Elem<10>{}, Elem<11>{}) == std::make_tuple(Elem<1>{}, Elem<2>{}, Elem<3>{}, Elem<10>{}, Elem<11>{}));
    }
  }
  ...
  // value category of the bind_front unspecified-type.
  {
    ...
    using X = decltype(x);
    TC_ASSERT_EXPR(static_cast<X&>(x)() == 1);
    TC_ASSERT_EXPR(static_cast<X const&>(x)() == 2);
    TC_ASSERT_EXPR(static_cast<X&&>(x)() == 3);
    TC_ASSERT_EXPR(static_cast<X const&&>(x)() == 4);
  }
  ...
  {
    {
      ...
      TC_ASSERT_EXPR(ret());
      TC_ASSERT_EXPR(ret(1, 2, 3));

      auto ret1 = std::move(ret);
      TC_ASSERT_EXPR(!ret());
      TC_ASSERT_EXPR(ret1());
      TC_ASSERT_EXPR(ret1(1, 2, 3));
...
int tc_utilities_function_objects_func_bind_front_bind_front(void) {
  test();
  static_assert(test());
