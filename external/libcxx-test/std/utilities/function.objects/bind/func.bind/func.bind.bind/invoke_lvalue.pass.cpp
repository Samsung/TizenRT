...
TEST_CONSTEXPR_CXX20 bool test_int_1() {
    ...
    {
    int i = 2;
    TC_ASSERT_EXPR(std::bind(f_int_1, _1)(i) == 3);
    TC_ASSERT_EXPR(std::bind(f_int_1, i)() == 3);
    }
    // function pointer
    {
    int (*fp)(int) = f_int_1;
    int i = 3;
    TC_ASSERT_EXPR(std::bind(fp, _1)(i) == 4);
    TC_ASSERT_EXPR(std::bind(fp, i)() == 4);
    }
    // functor
    {
    int i = 4;
    TC_ASSERT_EXPR(std::bind(A_int_1(), _1)(i) == 3);
    TC_ASSERT_EXPR(std::bind(A_int_1(), i)() == 3);
    }
    // member function pointer
    {
    A_int_1 a;
    ...
    A_int_1* ap = &a;
    TC_ASSERT_EXPR(std::bind(&A_int_1::mem1, _1)(ap) == 3);
    TC_ASSERT_EXPR(std::bind(&A_int_1::mem1, ap)() == 3);
    }
    // const member function pointer
    {
    A_int_1 a;
    ...
    A_int_1* ap = &a;
    TC_ASSERT_EXPR(std::bind(&A_int_1::mem2, _1)(ap) == 4);
    TC_ASSERT_EXPR(std::bind(&A_int_1::mem2, ap)() == 4);
    }
    // member data pointer
    {
    A_int_1 a;
    TC_ASSERT_EXPR(std::bind(&A_int_1::data_, _1)(a) == 5);
    TC_ASSERT_EXPR(std::bind(&A_int_1::data_, a)() == 5);
    A_int_1* ap = &a;
    TC_ASSERT_EXPR(std::bind(&A_int_1::data_, _1)(a) == 5);
    std::bind(&A_int_1::data_, _1)(a) = 6;
    TC_ASSERT_EXPR(std::bind(&A_int_1::data_, _1)(a) == 6);
    TC_ASSERT_EXPR(std::bind(&A_int_1::data_, _1)(ap) == 6);
    std::bind(&A_int_1::data_, _1)(ap) = 7;
    TC_ASSERT_EXPR(std::bind(&A_int_1::data_, _1)(ap) == 7);
    }
...
TEST_CONSTEXPR_CXX20 bool test_many_args() {
    ...
    TC_ASSERT_EXPR(&result == &a);
    return true;
}

int tc_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue(void) {
    test_void_1();
    test_int_1();
    test_void_2();
