...
test_int_1()
{
    ...
    A_int_1* ap = &a;
    TC_ASSERT_EXPR(r1(ap) == 6);
    r1(ap) = 7;
    TC_ASSERT_EXPR(r1(ap) == 7);
...
int tc_utilities_function_objects_refwrap_refwrap_invoke_invoke(void) {
    test_void_1();
    test_int_1();
    test_void_2();
    test_int_2();
