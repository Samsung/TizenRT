...
constexpr void test_direct_non_list_init() {
  ...
  TC_ASSERT_EXPR(n.value().value == 2);
}
...
int tc_utilities_expected_expected_expected_monadic_transform(void) {
  test();
  static_assert(test());
