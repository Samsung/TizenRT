...
int tc_utilities_allocator_adaptor_allocator_adaptor_cnstr_converting_move(void) {
    {
    ...
    }
    {
        ...
        TC_ASSERT_EXPR(A2<int>::move_called == true);
        TC_ASSERT_EXPR(a2 == a1);
    }
    {
        ...
        TC_ASSERT_EXPR(A3<int>::move_called == true);
        TC_ASSERT_EXPR(a2 == a1);
    }
