...
void test_derived_from_variant() {
  ...
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 42); }, v1);
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 142); }, cv1);
  std::visit([](auto x) { TC_ASSERT_EXPR(x == -1.25f); }, MyVariant{-1.25f});
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 42); }, std::move(v1));
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 142); }, std::move(cv1));
  ...
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 12); }, EvilVariant1{12});
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 12.3); }, EvilVariant1{12.3});
  ...
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 12); }, EvilVariant2{12});
  std::visit([](auto x) { TC_ASSERT_EXPR(x == 12.3); }, EvilVariant2{12.3});
}
