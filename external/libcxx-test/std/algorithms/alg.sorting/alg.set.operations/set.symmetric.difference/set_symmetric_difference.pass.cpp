...
// TrivialSortable tests with cpp17_input_iterator input
...
// TrivialSortable tests with forward_iterator input
...
// TrivialSortable tests with bidirectional_iterator input
...
// TrivialSortable tests with random_access_iterator input
...
// TrivialSortable tests with pointer input
...
// NonTrivialSortable tests - same pattern as above
...
void test_trivial_output_forward() {
    test4<TrivialSortable, random_access_iterator<const TrivialSortable*>, random_access_iterator<const TrivialSortable*>, forward_iterator<TrivialSortable*> >();
}
void test_trivial_output_bidirectional() {
    test4<TrivialSortable, random_access_iterator<const TrivialSortable*>, random_access_iterator<const TrivialSortable*>, bidirectional_iterator<TrivialSortable*> >();
}
void test_trivial_output_random() {
    test4<TrivialSortable, random_access_iterator<const TrivialSortable*>, random_access_iterator<const TrivialSortable*>, random_access_iterator<TrivialSortable*> >();
}
void test_trivial_output_pointer() {
    test4<TrivialSortable, random_access_iterator<const TrivialSortable*>, random_access_iterator<const TrivialSortable*>, TrivialSortable*>();
}

void test_nontrivial_output_forward() {
    test4<NonTrivialSortable, random_access_iterator<const NonTrivialSortable*>, random_access_iterator<const NonTrivialSortable*>, forward_iterator<NonTrivialSortable*> >();
}
void test_nontrivial_output_bidirectional() {
    test4<NonTrivialSortable, random_access_iterator<const NonTrivialSortable*>, random_access_iterator<const NonTrivialSortable*>, bidirectional_iterator<NonTrivialSortable*> >();
}
void test_nontrivial_output_random() {
    test4<NonTrivialSortable, random_access_iterator<const NonTrivialSortable*>, random_access_iterator<const NonTrivialSortable*>, random_access_iterator<NonTrivialSortable*> >();
}
void test_nontrivial_output_pointer() {
    test4<NonTrivialSortable, random_access_iterator<const NonTrivialSortable*>, random_access_iterator<const NonTrivialSortable*>, NonTrivialSortable*>();
}
