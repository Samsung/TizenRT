...
TEST_CONSTEXPR_CXX20 bool test()
{
    ...
    TC_ASSERT_EXPR(std::is_sorted(work, work+N, std::greater<T>()));
...
void test_sort_constexpr_comp_static_asserts() {
...
void run_all_sort_constexpr_comp_tests() {
    test_sort_constexpr_comp_small();
    test_sort_constexpr_comp_large();
#if TEST_STD_VER >= 11
    test_sort_constexpr_comp_moveonly_small();
    test_sort_constexpr_comp_moveonly_large();
#endif
    test_sort_constexpr_comp_pointers();
#if TEST_STD_VER >= 20
    test_sort_constexpr_comp_contiguous_small();
    test_sort_constexpr_comp_contiguous_large();
    test_sort_constexpr_comp_pointers_contiguous();
    test_sort_constexpr_comp_static_asserts();
#endif
}

int tc_libcxx_algorithms_alg_sorting_alg_sort_sort_sort_constexpr_comp(void) {
    run_all_sort_constexpr_comp_tests();
