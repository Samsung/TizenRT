...
struct Test {
  ...
  TEST_CONSTEXPR_CXX20 void operator()() {
    ...
    TC_ASSERT_EXPR(std::equal(Iter1(a), Iter1(a + s), Iter2(a)));
    TC_ASSERT_EXPR(!std::equal(Iter1(a), Iter1(a + s), Iter2(b)));

#if TEST_STD_VER >= 14
    TC_ASSERT_EXPR(std::equal(Iter1(a), Iter1(a + s), Iter2(a), std::equal_to<>()));
    TC_ASSERT_EXPR(!std::equal(Iter1(a), Iter1(a + s), Iter2(b), std::equal_to<>()));

    TC_ASSERT_EXPR(std::equal(Iter1(a), Iter1(a + s), Iter2(a), Iter2(a + s)));
    TC_ASSERT_EXPR(!std::equal(Iter1(a), Iter1(a + s), Iter2(a), Iter2(a + s - 1)));
    TC_ASSERT_EXPR(!std::equal(Iter1(a), Iter1(a + s), Iter2(b), Iter2(b + s)));

    TC_ASSERT_EXPR(std::equal(Iter1(a), Iter1(a + s), Iter2(a), Iter2(a + s), std::equal_to<>()));
    TC_ASSERT_EXPR(!std::equal(Iter1(a), Iter1(a + s), Iter2(a), Iter2(a + s - 1), std::equal_to<>()));
    TC_ASSERT_EXPR(!std::equal(Iter1(a), Iter1(a + s), Iter2(b), Iter2(b + s), std::equal_to<>()));
#endif
  }
};
...
struct TestNarrowingEqualTo {
  ...
  TEST_CONSTEXPR_CXX20 void operator()() {
    ...
    TC_ASSERT_EXPR(std::equal(a, a + 5, b, std::equal_to<char>()));
#if TEST_STD_VER >= 14
    TC_ASSERT_EXPR(std::equal(a, a + 5, b, b + 5, std::equal_to<char>()));
#endif
  }
};
...
int tc_libcxx_algorithms_alg_nonmodifying_alg_equal_equal(void) {
...

  {
    ...
    TC_ASSERT_EXPR(std::equal(a, a + 2, b));
#if TEST_STD_VER >= 14
    TC_ASSERT_EXPR(std::equal(a, a + 2, b, b + 2));
#endif
  }
