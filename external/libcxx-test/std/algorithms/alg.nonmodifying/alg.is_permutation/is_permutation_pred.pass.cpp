...
int tc_libcxx_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation_pred(void) {
    ...
    }
    {
        ...
        TC_ASSERT_EXPR( comparison_count > 0 );
        comparison_count = 0;
        TC_ASSERT_EXPR(std::is_permutation(random_access_iterator<const int*>(ia),
    ...
    }
    {
      ...
      TC_ASSERT_EXPR(std::is_permutation(forward_iterator<const S*>(a),
