...
struct Test {
  ...
  TEST_CONSTEXPR_CXX20 void operator()() {
    ...
    { // first element matches
      ...
      TC_ASSERT_EXPR(*iter == ArrayT(1));
      TC_ASSERT_EXPR(base(iter) == arr);
    }
