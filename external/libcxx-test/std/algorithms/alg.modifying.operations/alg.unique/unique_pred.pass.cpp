...
test()
{
    ...
    TC_ASSERT_EXPR(count_equal::count == sa-1);
    ...
    TC_ASSERT_EXPR(count_equal::count == sb-1);
    ...
    TC_ASSERT_EXPR(count_equal::count == sc-1);
    ...
    TC_ASSERT_EXPR(count_equal::count == sd-1);
    ...
    TC_ASSERT_EXPR(count_equal::count == se-1);
    ...
    TC_ASSERT_EXPR(count_equal::count == sg-1);

    int ih[] = {0, 1, 1};
    const unsigned sh = sizeof(ih)/sizeof(ih[0]);
    count_equal::count = 0;
    r = std::unique(Iter(ih), Iter(ih+sh), count_equal());
    TC_ASSERT_EXPR(base(r) == ih + 2);
    TC_ASSERT_EXPR(ih[0] == 0);
    TC_ASSERT_EXPR(ih[1] == 1);
    TC_ASSERT_EXPR(count_equal::count == sh-1);

    int ii[] = {0, 1, 1, 1, 2, 2, 2};
    const unsigned si = sizeof(ii)/sizeof(ii[0]);
    count_equal::count = 0;
    r = std::unique(Iter(ii), Iter(ii+si), count_equal());
    TC_ASSERT_EXPR(base(r) == ii + 3);
    TC_ASSERT_EXPR(ii[0] == 0);
    TC_ASSERT_EXPR(ii[1] == 1);
    TC_ASSERT_EXPR(ii[2] == 2);
    TC_ASSERT_EXPR(count_equal::count == si-1);
}
