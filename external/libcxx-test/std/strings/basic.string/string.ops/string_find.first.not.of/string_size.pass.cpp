...
static int test0()
{
    ...
    TC_ASSERT_FUNC((test(S("cdaih"), S("dmajblfhsg"), 1, 3)));
    ...
    TC_ASSERT_FUNC((test(S("qnsoh"), S("kojhpmbsfe"), 2, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("daiprenocl"), S("ashjd"), 0, 2)));
    TC_ASSERT_FUNC((test(S("litpcfdghe"), S("mgojkldsqh"), 0, 1)));
    ...
    TC_ASSERT_FUNC((test(S("nkodajteqp"), S("ofdrqmkebl"), 1, 4)));
    ...
    TC_ASSERT_FUNC((test(S("pnracgfkjdiholtbqsem"), S("tboimldpjh"), 0, 1)));
    ...
    TC_ASSERT_FUNC((test(S("rbtaqjhgkneisldpmfoc"), S("gtfblmqinc"), 1, 3)));
    ...
    TC_ASSERT_FUNC((test(S("jtlshdgqaiprkbcoenfm"), S("pblas"), 10, 11)));
    TC_ASSERT_FUNC((test(S("fkdrbqltsgmcoiphneaj"), S("arosdhcfme"), 10, 13)));
    ...
    TC_ASSERT_FUNC((test(S("mrtaefilpdsgocnhqbjk"), S("lgokshjtpb"), 19, S::npos)));
...
static int test1()
{
    ...
    TC_ASSERT_FUNC((test(S("nhmko"), S(""), 0)));
    TC_ASSERT_FUNC((test(S("lahfb"), S("irkhs"), 0)));
    TC_ASSERT_FUNC((test(S("gmfhd"), S("kantesmpgj"), 2)));
    TC_ASSERT_FUNC((test(S("odaft"), S("oknlrstdpiqmjbaghcfe"), S::npos)));
    TC_ASSERT_FUNC((test(S("eolhfgpjqk"), S(""), 0)));
    TC_ASSERT_FUNC((test(S("nbatdlmekr"), S("bnrpe"), 2)));
    TC_ASSERT_FUNC((test(S("jdmciepkaq"), S("jtdaefblso"), 2)));
    TC_ASSERT_FUNC((test(S("hkbgspoflt"), S("oselktgbcapndfjihrmq"), S::npos)));
    TC_ASSERT_FUNC((test(S("gprdcokbnjhlsfmtieqa"), S(""), 0)));
    TC_ASSERT_FUNC((test(S("qjghlnftcaismkropdeb"), S("bjaht"), 0)));
    TC_ASSERT_FUNC((test(S("pnalfrdtkqcmojiesbhg"), S("hjlcmgpket"), 1)));
