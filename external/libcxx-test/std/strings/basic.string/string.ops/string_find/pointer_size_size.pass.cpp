...
{
    TC_ASSERT_EXPR(s.find(str, pos, n) == x);
    if (x != S::npos)
        TC_ASSERT_EXPR(pos <= x && x + n <= s.size());
    return 0;
}
...
static int test0()
{
    ...
    TC_ASSERT_FUNC((test(S(""), "abcde", 1, 0, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S(""), "abcdeabcde", 1, 0, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S(""), "abcdeabcdeabcdeabcde", 1, 0, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 1, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 1, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 1, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 1, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 1, 0, 1)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 1, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 1, 5, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcdeabcdeabcde", 1, 1, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 2, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 2, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 2, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 2, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 2, 0, 2)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 2, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 2, 5, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcdeabcdeabcde", 2, 1, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 4, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 4, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 4, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 4, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 4, 0, 4)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 4, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 4, 5, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcdeabcdeabcde", 4, 1, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 5, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 5, 2, S::npos)));
    return 0;
}
...
static int test1()
{
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 5, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 5, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 5, 0, 5)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 5, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 5, 5, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcdeabcdeabcde", 5, 1, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), "", 6, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 6, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 6, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 6, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 6, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcde", 6, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 6, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 6, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 6, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 6, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcde", 6, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcdeabcdeabcde", 6, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcde"), "abcdeabcdeabcdeabcde", 6, 1, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 1, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 1, 2, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 1, 4, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 1, 5, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 1, 0, 1)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 1, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 1, 5, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 1, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 1, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 1, 0, 1)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 1, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 1, 10, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 5, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 5, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 5, 0, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 5, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 5, 10, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 9, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 9, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 9, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 9, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 9, 0, 9)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 9, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 9, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 9, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 9, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 9, 0, 9)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 9, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 9, 10, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 10, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 10, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 10, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 10, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 10, 0, 10)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 10, 1, S::npos)));
    return 0;
}
...
static int test2()
{
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 10, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 10, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 10, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 10, 0, 10)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 10, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 10, 10, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "", 11, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 11, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 11, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 11, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 11, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcde", 11, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 11, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 11, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 11, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 11, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcde", 11, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 11, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 11, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcde"), "abcdeabcdeabcdeabcde", 11, 10, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 1, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 1, 2, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 1, 4, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 1, 5, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 1, 0, 1)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 1, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 1, 5, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 1, 9, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 1, 10, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 1, 0, 1)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 1, 1, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 1, 10, 5)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 1, 19, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 1, 20, S::npos)));
    ...
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 10, 19, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 10, 20, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "", 19, 0, 19)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 19, 0, 19)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 19, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 19, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 19, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 19, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 19, 0, 19)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 19, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 19, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 19, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 19, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 19, 0, 19)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 19, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 19, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 19, 19, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 19, 20, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "", 20, 0, 20)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 20, 0, 20)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 20, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 20, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 20, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 20, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 20, 0, 20)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 20, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 20, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 20, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 20, 10, S::npos)));
...
static int test3()
{
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 20, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 20, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 20, 19, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 20, 20, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "", 21, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 21, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 21, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 21, 2, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 21, 4, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcde", 21, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 21, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 21, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 21, 5, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 21, 9, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcde", 21, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 21, 0, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 21, 1, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 21, 10, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 21, 19, S::npos)));
    TC_ASSERT_FUNC((test(S("abcdeabcdeabcdeabcde"), "abcdeabcdeabcdeabcde", 21, 20, S::npos)));
    return 0;
}
