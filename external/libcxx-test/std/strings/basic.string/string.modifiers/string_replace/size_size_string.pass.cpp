...
static int test0()
{
    ...
    TC_ASSERT_FUNC((test(S(""), 0, 1, S(""), S(""))));
    TC_ASSERT_FUNC((test(S(""), 0, 1, S("12345"), S("12345"))));
    TC_ASSERT_FUNC((test(S(""), 0, 1, S("1234567890"), S("1234567890"))));
    TC_ASSERT_FUNC((test(S(""), 0, 1, S("12345678901234567890"), S("12345678901234567890"))));
    TC_ASSERT_FUNC((test(S(""), 1, 0, S(""), S("can't happen"))));
    TC_ASSERT_FUNC((test(S(""), 1, 0, S("12345"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S(""), 1, 0, S("1234567890"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S(""), 1, 0, S("12345678901234567890"), S("can't happen"))));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), 0, 6, S(""), S(""))));
    TC_ASSERT_FUNC((test(S("abcde"), 0, 6, S("12345"), S("12345"))));
    TC_ASSERT_FUNC((test(S("abcde"), 0, 6, S("1234567890"), S("1234567890"))));
    TC_ASSERT_FUNC((test(S("abcde"), 0, 6, S("12345678901234567890"), S("12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), 1, 5, S(""), S("a"))));
    TC_ASSERT_FUNC((test(S("abcde"), 1, 5, S("12345"), S("a12345"))));
    TC_ASSERT_FUNC((test(S("abcde"), 1, 5, S("1234567890"), S("a1234567890"))));
    TC_ASSERT_FUNC((test(S("abcde"), 1, 5, S("12345678901234567890"), S("a12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), 2, 4, S(""), S("ab"))));
    TC_ASSERT_FUNC((test(S("abcde"), 2, 4, S("12345"), S("ab12345"))));
    TC_ASSERT_FUNC((test(S("abcde"), 2, 4, S("1234567890"), S("ab1234567890"))));
    TC_ASSERT_FUNC((test(S("abcde"), 2, 4, S("12345678901234567890"), S("ab12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), 4, 2, S(""), S("abcd"))));
    TC_ASSERT_FUNC((test(S("abcde"), 4, 2, S("12345"), S("abcd12345"))));
    TC_ASSERT_FUNC((test(S("abcde"), 4, 2, S("1234567890"), S("abcd1234567890"))));
    TC_ASSERT_FUNC((test(S("abcde"), 4, 2, S("12345678901234567890"), S("abcd12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcde"), 5, 1, S(""), S("abcde"))));
    TC_ASSERT_FUNC((test(S("abcde"), 5, 1, S("12345"), S("abcde12345"))));
    TC_ASSERT_FUNC((test(S("abcde"), 5, 1, S("1234567890"), S("abcde1234567890"))));
    TC_ASSERT_FUNC((test(S("abcde"), 5, 1, S("12345678901234567890"), S("abcde12345678901234567890"))));
    return 0;
}
...
static int test1()
{
    TC_ASSERT_FUNC((test(S("abcde"), 6, 0, S(""), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcde"), 6, 0, S("12345"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcde"), 6, 0, S("1234567890"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcde"), 6, 0, S("12345678901234567890"), S("can't happen"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghij"), 0, 11, S(""), S(""))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 0, 11, S("12345"), S("12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 0, 11, S("1234567890"), S("1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 0, 11, S("12345678901234567890"), S("12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghij"), 1, 10, S(""), S("a"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 1, 10, S("12345"), S("a12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 1, 10, S("1234567890"), S("a1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 1, 10, S("12345678901234567890"), S("a12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghij"), 5, 6, S(""), S("abcde"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 5, 6, S("12345"), S("abcde12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 5, 6, S("1234567890"), S("abcde1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 5, 6, S("12345678901234567890"), S("abcde12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghij"), 9, 2, S(""), S("abcdefghi"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 9, 2, S("12345"), S("abcdefghi12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 9, 2, S("1234567890"), S("abcdefghi1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 9, 2, S("12345678901234567890"), S("abcdefghi12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghij"), 10, 1, S(""), S("abcdefghij"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 10, 1, S("12345"), S("abcdefghij12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 10, 1, S("1234567890"), S("abcdefghij1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 10, 1, S("12345678901234567890"), S("abcdefghij12345678901234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 11, 0, S(""), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 11, 0, S("12345"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 11, 0, S("1234567890"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcdefghij"), 11, 0, S("12345678901234567890"), S("can't happen"))));
    return 0;
}
...
static int test2()
{
    ...
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 0, 21, S(""), S(""))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 0, 21, S("12345"), S("12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 0, 21, S("1234567890"), S("1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 0, 21, S("12345678901234567890"), S("12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 1, 20, S(""), S("a"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 1, 20, S("12345"), S("a12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 1, 20, S("1234567890"), S("a1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 1, 20, S("12345678901234567890"), S("a12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 10, 11, S(""), S("abcdefghij"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 10, 11, S("12345"), S("abcdefghij12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 10, 11, S("1234567890"), S("abcdefghij1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 10, 11, S("12345678901234567890"), S("abcdefghij12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 19, 2, S(""), S("abcdefghijklmnopqrs"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 19, 2, S("12345"), S("abcdefghijklmnopqrs12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 19, 2, S("1234567890"), S("abcdefghijklmnopqrs1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 19, 2, S("12345678901234567890"), S("abcdefghijklmnopqrs12345678901234567890"))));
    ...
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 20, 1, S(""), S("abcdefghijklmnopqrst"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 20, 1, S("12345"), S("abcdefghijklmnopqrst12345"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 20, 1, S("1234567890"), S("abcdefghijklmnopqrst1234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 20, 1, S("12345678901234567890"), S("abcdefghijklmnopqrst12345678901234567890"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 21, 0, S(""), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 21, 0, S("12345"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 21, 0, S("1234567890"), S("can't happen"))));
    TC_ASSERT_FUNC((test(S("abcdefghijklmnopqrst"), 21, 0, S("12345678901234567890"), S("can't happen"))));
    return 0;
}
