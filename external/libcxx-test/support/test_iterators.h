...
// Backward compatibility alias for tests using input_iterator
template <class It>
...
public:
    ...
    // Support mixed iterator types (e.g., random_access_iterator<const char*> and random_access_iterator<char*>)
    template <class U>
    friend TEST_CONSTEXPR difference_type operator-(const random_access_iterator& x, const random_access_iterator<U>& y) {return x.it_ - base(y);}
