...
/* TizenRT does not define _POSIX_VERSION, so platform_util.c cannot
 * auto-detect clock_gettime availability.  Provide our own implementation
 * in alt/ms_time_alt.c using clock_gettime(CLOCK_MONOTONIC) directly. */
