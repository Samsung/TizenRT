...
struct __builtin_new_allocator {
  struct __builtin_new_deleter {
    ...
    typedef void* pointer;  // TizenRT compatibility: Add explicit pointer typedef for unique_ptr
  ...
  _LIBCPP_HIDE_FROM_ABI static __holder_t __allocate_bytes(size_t __s, size_t __align) {
      void* __p = _VSTD::__libcpp_allocate(__s, __align);
      return __holder_t(__p, __builtin_new_deleter(__s, __align));
  }
