...
#include "test_models/cast/FloatCastKernel.h"
#include "test_models/cast/NegCastKernel.h"
...
{
  onert_micro::test_model::TestDataFloatCast test_data_kernel;
...
{
  onert_micro::test_model::NegTestDataInputOutputShapeMismatchCastKernel test_data_kernel;
