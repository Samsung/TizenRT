...
#include "test_models/ceil/FloatCeilKernel.h"
#include "test_models/ceil/NegCeilKernel.h"
...
{
  onert_micro::test_model::TestDataFloatCeil test_data_kernel;
...
{
  onert_micro::test_model::NegTestDataInputOutputTypeMismatchCeilKernel test_data_kernel;
