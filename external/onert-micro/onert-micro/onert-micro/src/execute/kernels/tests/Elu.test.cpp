...
#include "test_models/elu/FloatEluKernel.h"
#include "test_models/elu/NegEluKernel.h"
...
{
  onert_micro::test_model::TestDataFloatElu test_data_kernel;
...
{
  onert_micro::test_model::NegTestDataInputOutputTypeMismatchEluKernel test_data_kernel;
