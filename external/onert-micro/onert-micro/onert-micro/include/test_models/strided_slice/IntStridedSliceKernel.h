...
#ifndef ONERT_MICRO_TEST_MODELS_INT_STRIDED_SLICE_KERNEL_H
#define ONERT_MICRO_TEST_MODELS_INT_STRIDED_SLICE_KERNEL_H
...
const unsigned char test_kernel_model_circle[] = {
  ...
  0x05, 0x00, 0x00, 0x00, 0xc0, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00,
  0x34, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x60, 0xff, 0xff, 0xff, 0x10, 0x00, 0x00, 0x00,
  ...
  0x03, 0x00, 0x00, 0x00, 0x8c, 0xff, 0xff, 0xff, 0x10, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x02, 0x10, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x73, 0x74, 0x72, 0x69,
  0x64, 0x65, 0x73, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0xb4, 0xff, 0xff, 0xff,
...
const std::vector<int32_t> input_data = {855, 230, 357, 122, 544, 799,

                                         566, 1,   940, 634, 32,  6,

                                         135, 917, 24,  12,  678, 370};

const std::vector<int32_t> reference_output_data = {566, 1, 940};

} // namespace strided_slice_int

class TestDataIntStridedSlice : public TestDataStridedSliceBase<int32_t>
{
public:
  TestDataIntStridedSlice()
  {
    _input_data = strided_slice_int::input_data;
    _reference_output_data = strided_slice_int::reference_output_data;
    _test_kernel_model_circle = strided_slice_int::test_kernel_model_circle;
  }

  ~TestDataIntStridedSlice() override = default;
};

} // namespace test_model
} // namespace onert_micro

#endif // ONERT_MICRO_TEST_MODELS_INT_STRIDED_SLICE_KERNEL_H
