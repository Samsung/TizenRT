...
#ifndef ONERT_MICRO_TEST_MODELS_STRIDED_SLICE_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_STRIDED_SLICE_KERNEL_BASE_H
...
template <typename T> class TestDataStridedSliceBase : public TestDataBase<T>
{
public:
  TestDataStridedSliceBase() = default;
...
#endif // ONERT_MICRO_TEST_MODELS_STRIDED_SLICE_KERNEL_BASE_H
