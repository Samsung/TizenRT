...
#ifndef ONERT_MICRO_TEST_MODELS_CONCATENATION_KERNEL_S8_H
#define ONERT_MICRO_TEST_MODELS_CONCATENATION_KERNEL_S8_H
...
const unsigned char test_kernel_model_circle[] = {
  ...
  0x10, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x50, 0x02, 0x00, 0x00, 0x6c, 0x02, 0x00, 0x00,
  0x04, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
  0x04, 0x00, 0x00, 0x00, 0xf4, 0xff, 0xff, 0xff, 0xf8, 0xff, 0xff, 0xff, 0xfc, 0xff, 0xff, 0xff,
  ...
  0x00, 0x00, 0x00, 0x0a, 0x14, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0x01, 0x00, 0x00, 0x00,
  ...
  0x04, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0e, 0x00,
  ...
  0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfe, 0x42,
...
const std::vector<int8_t> input1_data = {-9,  -22, -32, 7,   -23, -8, -23, -32,
                                         -31, -25, -8,  -22, -23, 1,  -24, -32};
const std::vector<int8_t> input2_data = {-29, -31, -8,  -23, 16,  -23, -38, 7,   -36, -22, -32,
...
class TestDataS8Concatenation : public TestDataConcatenationBase<int8_t>
{
public:
  TestDataS8Concatenation()
  {
    _input1_data = concatenation_s8::input1_data;
    _input2_data = concatenation_s8::input2_data;
    _reference_output_data = concatenation_s8::reference_output_data;
    _test_kernel_model_circle = concatenation_s8::test_kernel_model_circle;
  }

  ~TestDataS8Concatenation() override = default;
};

} // namespace test_model
} // namespace onert_micro

#endif // ONERT_MICRO_TEST_MODELS_CONCATENATION_KERNEL_S8_H
