...
#ifndef ONERT_MICRO_TEST_MODELS_SPLITV_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_SPLITV_KERNEL_BASE_H
...
template <typename T> class TestDataSplitVBase : public TestDataBase<T>
{
public:
  TestDataSplitVBase() = default;
...
#endif // ONERT_MICRO_TEST_MODELS_SPLITV_KERNEL_BASE_H
