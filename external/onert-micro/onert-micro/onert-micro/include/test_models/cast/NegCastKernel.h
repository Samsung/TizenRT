...
#ifndef ONERT_MICRO_TEST_MODELS_NEG_CAST_KERNEL_H
#define ONERT_MICRO_TEST_MODELS_NEG_CAST_KERNEL_H
...
class NegTestDataInputOutputShapeMismatchCastKernel : public NegTestDataBase
{
public:
  ...
  ~NegTestDataInputOutputShapeMismatchCastKernel() override = default;
...
#endif // ONERT_MICRO_TEST_MODELS_NEG_CAST_KERNEL_H
