...
{
/*
 * ReLU6 Kernel with input output shape mismatch:
 *
 *      Input(1, 3, 3, 2)
 *            |
 *          ReLU6
...
const unsigned char test_kernel_model_circle[] = {
  ...
  0x00, 0x00, 0x00, 0x09, 0x0c, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x6f, 0x66, 0x6d, 0x00,
  ...
  0x0c, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09,
...
class NegTestDataInputOutputShapeMismatchReLU6Kernel : public NegTestDataBase
{
public:
  NegTestDataInputOutputShapeMismatchReLU6Kernel()
  {
    _test_kernel_model_circle = neg_input_output_shape_mismatch_kernel::test_kernel_model_circle;
  }
