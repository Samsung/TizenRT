...
#ifndef ONERT_MICRO_TEST_MODELS_QUANTIZE_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_QUANTIZE_KERNEL_BASE_H
...
template <typename T, typename O> class TestDataQuantizeBase : public TestDataBase<T, O>
{
public:
...
#endif // ONERT_MICRO_TEST_MODELS_QUANTIZE_KERNEL_BASE_H
