...
#ifndef ONERT_MICRO_TEST_MODELS_GRU_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_GRU_KERNEL_BASE_H
...
template <typename T> class TestDataGRUBase : public TestDataBase<T>
{
public:
  TestDataGRUBase() = default;
...
#endif // ONERT_MICRO_TEST_MODELS_GRU_KERNEL_BASE_H
