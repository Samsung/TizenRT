...
#ifndef ONERT_MICRO_TEST_MODELS_INT8_RELU_KERNEL_H
#define ONERT_MICRO_TEST_MODELS_INT8_RELU_KERNEL_H
...
class TestDataS8ReLU : public TestDataReLUBase<int8_t>
{
public:
  TestDataS8ReLU()
  {
    _input_data = relu_s8::input_data;
    _reference_output_data = relu_s8::reference_output_data;
    _test_kernel_model_circle = relu_s8::test_kernel_model_circle;
  }

  ~TestDataS8ReLU() override = default;
};

} // namespace test_model
} // namespace onert_micro

#endif // ONERT_MICRO_TEST_MODELS_INT8_RELU_KERNEL_H
