#ifndef INCLUDE_ARTIK_A710_PLATFORM_H_
#define INCLUDE_ARTIK_A710_PLATFORM_H_

/*! \file artik_a710_platform.h
 *
 *  \brief Hardware specific definitions for the ARTIK 710 Development platform
 *
 */

/* List of modules available for the platform */
static const artik_api_module artik_api_a710_modules[] = {
...
#define ARTIK_A710_GPIO2	130
#define ARTIK_A710_GPIO3	46
#define ARTIK_A710_GPIO4	14
#define ARTIK_A710_GPIO5	41
#define ARTIK_A710_GPIO6	25
#define ARTIK_A710_GPIO7	0
#define ARTIK_A710_GPIO8	26
#define ARTIK_A710_GPIO9	27
#define ARTIK_A710_AGPIO0	161

/* List of available UART IDs */
#define ARTIK_A710_UART0		4

/* List of available PWMIO IDs */
#define ARTIK_A710_PWM0			((0 << 8) | 2)

/* List of available Analog Input IDs */
#define ARTIK_A710_ADC0		0
#define ARTIK_A710_ADC1		1
#define ARTIK_A710_ADC2		2
#define ARTIK_A710_ADC3		3
#define ARTIK_A710_ADC4		4
#define ARTIK_A710_ADC5		5

/* List of available I2C controllers  */
#define ARTIK_A710_I2C		1

/* List of available SPI controllers  */
#define ARTIK_A710_SPI0		0

#endif /* INCLUDE_ARTIK_A710_PLATFORM_H_ */
