 ...
 */
void wpa_msg_global(void *ctx, int level, const char *fmt, ...) PRINTF_FORMAT(3, 4);
 ...
 */
void wpa_msg_global_ctrl(void *ctx, int level, const char *fmt, ...) PRINTF_FORMAT(3, 4);
...
void hostapd_logger(void *ctx, const u8 *addr, unsigned int module, int level, const char *fmt, ...) PRINTF_FORMAT(5, 6);

typedef void (*hostapd_logger_cb_func)(void *ctx, const u8 *addr, unsigned int module, int level, const char *txt, size_t len);
