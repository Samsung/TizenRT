...
static int aes_kdf_128(const u8 *kdk, const char *label, const u8 *context, int ctx_bits, int ret_bits, u8 *ret)
{
	const int h = 128;
	const int r = 8;
	int i, n;
...
int ieee802_1x_cak_128bits_aes_cmac(const u8 *msk, const u8 *mac1, const u8 *mac2, u8 *cak)
{
	...
	return aes_kdf_128(msk, "IEEE8021 EAP CAK", context, sizeof(context) * 8, 128, cak);
}
...
int ieee802_1x_kek_128bits_aes_cmac(const u8 *cak, const u8 *ckn, size_t ckn_bytes, u8 *kek)
{
	...
	return aes_kdf_128(cak, "IEEE8021 KEK", context, sizeof(context) * 8, 128, kek);
}
...
int ieee802_1x_ick_128bits_aes_cmac(const u8 *cak, const u8 *ckn, size_t ckn_bytes, u8 *ick)
{
	...
	return aes_kdf_128(cak, "IEEE8021 ICK", context, sizeof(context) * 8, 128, ick);
}
