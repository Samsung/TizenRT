...
enum qca_wlan_vendor_attr_data_offload_ind {
	...
	QCA_WLAN_VENDOR_ATTR_DATA_OFFLOAD_IND_MAX = QCA_WLAN_VENDOR_ATTR_DATA_OFFLOAD_IND_AFTER_LAST - 1
};
...
enum qca_vendor_attr_get_preferred_freq_list {
	...
	QCA_WLAN_VENDOR_ATTR_GET_PREFERRED_FREQ_LIST_MAX = QCA_WLAN_VENDOR_ATTR_GET_PREFERRED_FREQ_LIST_AFTER_LAST - 1
};
...
enum qca_vendor_attr_probable_oper_channel {
	...
	QCA_WLAN_VENDOR_ATTR_PROBABLE_OPER_CHANNEL_MAX = QCA_WLAN_VENDOR_ATTR_PROBABLE_OPER_CHANNEL_AFTER_LAST - 1
};
