...
/**
 * An implementation that allows us to store messages using Arastorage.
 *
 * This class is not thread-safe.
 */
class AraMessageStorage : public MessageStorageInterface {
public:
	/**
	 * Factory method for creating a storage object for Messages based on an Arastorage database.
	 *
	 ...
	 */
	static std::unique_ptr<AraMessageStorage> create(
	 ...
	 */
	AraMessageStorage(const std::string& databaseFilePath);
