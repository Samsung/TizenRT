        ...
        if (exp < 16)
        {
            ...
            switch (wnd_seq)
            {
...

                {
                    ...
                    {
                        /* const Int16 * */ // shadowed declaration
						pLong_Window_2 = &Long_Window_fxp[wnd_shape_this_bk][LONG_WINDOW_m_1];

                        Int32 * pFreq2T   = (Int32 *)pFreqInfo;
                        Int32 * pFreq2T_2 = &pFreq2T[HALF_LONG_WINDOW];
                        Int32 * win = (Int32 *) & Long_Window_fxp[wnd_shape_prev_bk][0];

                        /* Int */ // shadowed declaration
						shift = exp + 15 - SCALING;
                ...
                case LONG_START_SEQUENCE:
                    ...
                    {
                        // shadowed declaration: shift
                        Int shift2 = -exp;
                        for (i = (W_L_START_1 - LONG_WINDOW) >> 1; i != 0 ; i--)
                        {
                            Int32 temp2 = ((Int32) * (pFreq_2_Time_data_1++)) << shift2;
                            *(pOverlap_and_Add_Buffer_1++) = temp2;
                            temp2 = ((Int32) * (pFreq_2_Time_data_1++)) << shift2;
                            *(pOverlap_and_Add_Buffer_1++) = temp2;
                        }
