 ...
 * It should be included immediately before curl_memdebug.h as the last files
...
#error "Header curl_memdebug.h shall not be included before curl_memory.h"
#endif
 ...
 * realloc and free, along with others, in curl_memdebug.h in a different
 ...
 * from curl_memdebug.h are the ones that shall be used.
 */
