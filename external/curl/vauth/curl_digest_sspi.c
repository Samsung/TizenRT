...
#if defined(USE_WINDOWS_SSPI) && !defined(CONFIG_DISABLE_CRYPTO_AUTH)

#include <curl/curl.h>

#include "vauth/curl_vauth.h"
#include "vauth/curl_digest.h"
...
#endif /* USE_WINDOWS_SSPI && !CONFIG_DISABLE_CRYPTO_AUTH */
