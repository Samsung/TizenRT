...
#if defined(CONFIG_OPENSSL) || defined(CONFIG_GNUTLS) || defined(CONFIG_SCHANNEL) || \
  defined(CONFIG_DARWINSSL) || defined(CONFIG_POLARSSL) || defined(CONFIG_NSS) || \
...
/* CONFIG_OPENSSL || CONFIG_GNUTLS || CONFIG_SCHANNEL || CONFIG_DARWINSSL || CONFIG_NSS */
#endif
...
#if defined(CONFIG_SSL_SUPPORT)
  &Curl_ssl_multi;
#elif defined(CONFIG_AXTLS)
  &Curl_ssl_axtls;
#elif defined(CONFIG_CYASSL)
  &Curl_ssl_cyassl;
#elif defined(CONFIG_DARWINSSL)
  &Curl_ssl_darwinssl;
#elif defined(CONFIG_GNUTLS)
  &Curl_ssl_gnutls;
#elif defined(CONFIG_GSKIT)
  &Curl_ssl_gskit;
#elif defined(CONFIG_MBEDTLS)
  &Curl_ssl_mbedtls;
#elif defined(CONFIG_NSS)
  &Curl_ssl_nss;
#elif defined(CONFIG_OPENSSL)
  &Curl_ssl_openssl;
#elif defined(CONFIG_POLARSSL)
  &Curl_ssl_polarssl;
#elif defined(CONFIG_SCHANNEL)
  &Curl_ssl_schannel;
#else
...
static const struct Curl_ssl *available_backends[] = {
  ...
  &Curl_ssl_axtls,
#endif
#if defined(CONFIG_CYASSL)
  &Curl_ssl_cyassl,
#endif
#if defined(CONFIG_DARWINSSL)
  &Curl_ssl_darwinssl,
#endif
#if defined(CONFIG_GNUTLS)
  &Curl_ssl_gnutls,
#endif
#if defined(CONFIG_GSKIT)
  &Curl_ssl_gskit,
#endif
#if defined(CONFIG_MBEDTLS)
  &Curl_ssl_mbedtls,
#endif
#if defined(CONFIG_NSS)
  &Curl_ssl_nss,
#endif
#if defined(CONFIG_OPENSSL)
  &Curl_ssl_openssl,
#endif
#if defined(CONFIG_POLARSSL)
  &Curl_ssl_polarssl,
#endif
#if defined(CONFIG_SCHANNEL)
  &Curl_ssl_schannel,
#endif
  NULL
};
