...
/* Original Curl makes this file automatically when it is built using cmake.
But we don't support cmake so that we use the fixed file. */
...
//#define HAVE_GETIFADDRS 1 // cs.bhargava, Add Interface Address file to Tizen RT common/
...
//#define HAVE_IF_NAMETOINDEX 1 // Name to Interface to be added for CURL ,, cs.bhargava
