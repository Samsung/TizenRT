...
#define AWS_IOT_MQTT_CLIENT_ID         CONFIG_AWS_IOT_MY_THING_NAME ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          CONFIG_AWS_IOT_MY_THING_NAME ///< Thing Name of the Shadow this device is associated with
...
#define DISABLE_METRICS 0 ///< Disable the collection of metrics by setting this to true
