 ...
 */
#ifdef CONFIG_AWS_LOG_DEBUG // ENABLE_IOT_DEBUG
#define IOT_DEBUG(...)    \
	{\
 ...
 */
#ifdef CONFIG_AWS_LOG_TRACE // ENABLE_IOT_TRACE
#define FUNC_ENTRY    \
	{\
 ...
 */
#ifdef CONFIG_AWS_LOG_INFO // ENABLE_IOT_INFO
#define IOT_INFO(...)    \
	{\
	printf(__VA_ARGS__); \
	printf("\n"); \
 ...
 * Macro to expose function, line number as well as desired log message.
 */
#ifdef CONFIG_AWS_LOG_WARN // ENABLE_IOT_WARN
#define IOT_WARN(...)   \
	{ \
 ...
 * Macro to expose function, line number as well as desired log message.
 */
#ifdef CONFIG_AWS_LOG_ERROR // ENABLE_IOT_ERROR
#define IOT_ERROR(...)  \
	{ \
