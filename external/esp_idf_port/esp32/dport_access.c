...
{
#ifndef CONFIG_RTOS_UNICORE
	if (dport_core_state[0] == DPORT_CORE_STATE_IDLE || dport_core_state[1] == DPORT_CORE_STATE_IDLE) {
		return;
	}
...
{
#if defined(BOOTLOADER_BUILD) || defined(CONFIG_RTOS_UNICORE) || !defined(ESP_PLATFORM)
