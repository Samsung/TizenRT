#ifndef __IPERF2_CONFIG_H__
#define __IPERF2_CONFIG_H__
...
/* Define to 1 if you have the declaration of `MCAST_JOIN_SOURCE_GROUP', and
   to 0 if you don't. */
#define HAVE_DECL_MCAST_JOIN_SOURCE_GROUP 0
...
/* Define to 1 if you have the declaration of `SO_MAX_PACING_RATE', and to 0
   if you don't. */
#define HAVE_DECL_SO_MAX_PACING_RATE 0 /*  TizenRT */
...
/* Define to 1 if you have the declaration of `SO_TIMESTAMP', and to 0 if you
   don't. */
#define HAVE_DECL_SO_TIMESTAMP 0
...
/* #define HAVE_NETINET_IN_H 1 :TizenRT no netinet/tcp.h */
...
#define PACKAGE_STRING "Iperf 2.0.14a"
...
#define PACKAGE_VERSION "2.0.14a"
...
/*
 * Those declarations definitions are defined To support TizenRT
 */
struct udphdr
{
  __extension__ union
...
/*  Define signal number just build iperf2  */
#define SIGHUP 1
#define SIGINT 2
#define SIGQUIT 3
#ifndef SIGCHLD
