...
/* This constant represents the range of x values our model was trained on, which is from 0 to (2 * Pi). We approximate Pi to avoid requiring additional libraries. */
