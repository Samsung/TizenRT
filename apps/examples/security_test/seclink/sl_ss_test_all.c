...
void sl_handle_ss_write(sl_options *opt)
{
	_sl_init_sstest();
	ST_SET_PACK(sl_ss);
	ST_SET_SMOKE(sl_ss, opt->count, 0, "ecdh compute", write_storage);
	ST_RUN_TEST(sl_ss);
...
void sl_handle_ss_read(sl_options *opt)
{
	_sl_init_sstest();
	ST_SET_PACK(sl_ss);
	ST_SET_SMOKE(sl_ss, opt->count, 0, "ecdh compute", read_storage);
	ST_RUN_TEST(sl_ss);
	ST_RESULT_TEST(sl_ss);
	_sl_deinit_sstest();
}
...
void sl_handle_ss_delete(sl_options *opt)
{
	_sl_init_sstest();
	ST_SET_PACK(sl_ss);
	ST_SET_SMOKE(sl_ss, opt->count, 0, "ecdh compute", delete_storage);
	ST_RUN_TEST(sl_ss);
	ST_RESULT_TEST(sl_ss);
	_sl_deinit_sstest();
}
