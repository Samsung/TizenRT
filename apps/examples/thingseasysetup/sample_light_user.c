...
bool g_switch_value = true;

bool handle_get_request_on_switch(ocf_things_get_request_message_s* req_msg, ocf_things_representation_s* resp_rep)
{
...
bool handle_set_request_on_switch(ocf_things_set_request_message_s* req_msg, ocf_things_representation_s* resp_rep)
{
    ...
    if (is_value_changed)
    {
        ocf_things_notify_observers(req_msg->resource_uri);
        ocf_things_send_push_message(req_msg->resource_uri, resp_rep);
    }
