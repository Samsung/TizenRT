...
void display_detailed_usage_examples(void)
{
	printf("CSIFW_TEST_APP: CSI_TESTER APP usage: csifw_tc {option} [config_type] [interval] [run_time]\n"
			...
			"    Usage: csifw_tc 14 [config_type] [interval]\n"
			"    Example: csifw_tc 14 2 70\n"
			...
			"    Usage: csifw_tc 15 [config_type] [interval]\n"
			"    Example: csifw_tc 15 3 65\n"
			...
			"    Usage: csifw_tc 16 [config_type] [interval] [run_time]\n"
			"    Example: csifw_tc 16 0 64 100\n"
