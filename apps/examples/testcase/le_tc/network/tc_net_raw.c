...
/**
* @testcase             :tc_net_raw_server
* @brief                :create the raw server
* @scenario             :none
* @apicovered           :socket, bind, listen
* @precondition         :socket file descriptor
* @postcondition        :none
* @return               :void
*/
...
/**
* @testcase             :tc_net_raw_client
* @brief                :create the raw client
* @scenario             :none
* @apicovered           :socket, setsockopt, recv
* @precondition         :socket file descriptor.
* @postcondition        :none
* @return               :void
*/
