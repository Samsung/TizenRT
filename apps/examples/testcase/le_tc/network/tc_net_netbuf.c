...
* @apicovered            :netbuf_new, netbuf_alloc, netbuf_first
* @precondition          :none
* @postcondition         :none
* @return                :void
*/
...
* @brief                 :chain one netbuf to another.
* @scenario              :none
* @apicovered            :netbuf_chain, netbuf_new, netbuf_delete
* @precondition          :none
* @postcondition         :none
* @return                :void
*/
...
* @apicovered            :netbuf_new, netbuf_delete
* @precondition          :new
* @postcondition         :new
* @return                :void
*/
