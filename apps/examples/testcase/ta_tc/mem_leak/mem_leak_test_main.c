 ...
 *   mem_leak_test 41        - Test E1: C++ array cookie (single element)
 *   mem_leak_test 42        - Test E2: C++ array cookie (multi-element)
...
/* Category E: C++ Interior Pointers */
...
static void print_usage(void)
{
	...
	printf("\n");
	printf("  After running a test, use 'mem_leak'\n");
	...
	printf("\n");
	printf("  Category E: C++ Interior Pointers:\n");
	printf("    41 C++ array cookie (new T[1])               [E1]\n");
	printf("    42 C++ array cookie (new T[2])               [E2]\n");
	printf("\n");
...
#endif
{
	...
	/* Category E: C++ Interior Pointers */
	case 41:
		test_cpp_array_cookie();
		break;
	case 42:
		test_cpp_array_cookie_multi();
		break;
