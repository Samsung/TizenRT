...
/**
* @testcase         itc_systemio_iotbus_spi_open_close_p
...
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_open_close_p(void)
{
...
/**
* @testcase         itc_systemio_iotbus_spi_open_close_p_multi_handler
...
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_open_close_p_multi_handler(void)
{
	int ret = IOTBUS_ERROR_NONE;
...
/**
* @testcase         itc_systemio_iotbus_spi_open_close_p_modes
...
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_open_close_p_modes(void)
{
	int ret = IOTBUS_ERROR_NONE;
	int max_index = 4;
	int check_open = 0;
...
/**
* @testcase         itc_systemio_iotbus_spi_open_close_n_invalid_bus
* @brief            initializes and closes the spi_context
* @scenario         initializes and closes the spi_context
* @apicovered       iotbus_spi_open, iotbus_spi_close
* @precondition     none
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_open_close_n_invalid_bus(void)
{
	int ret = IOTBUS_ERROR_NONE;
	int invalid_bus = -1;
...
/**
* @testcase         itc_systemio_iotbus_spi_open_close_n_invalid_bpw
* @brief            initializes and closes the spi_context
* @scenario         initializes and closes the spi_context
* @apicovered       iotbus_spi_open, iotbus_spi_close
* @precondition     none
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_open_close_n_invalid_bpw(void)
{
	int ret = IOTBUS_ERROR_NONE;
...
/**
* @testcase         itc_systemio_iotbus_spi_open_close_n_invalid_frequecy
* @brief            initializes and closes the spi_context
* @scenario         initializes and closes the spi_context
* @apicovered       iotbus_spi_open, iotbus_spi_close
* @precondition     none
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_open_close_n_invalid_frequecy(void)
{
	int ret = IOTBUS_ERROR_NONE;
...
/**
* @testcase         itc_systemio_iotbus_spi_write_recv_trasfer_p
...
* @postcondition    none
*/
static void itc_systemio_iotbus_spi_write_recv_trasfer_p(void)
{
...
{
	itc_systemio_iotbus_spi_open_close_p();
	itc_systemio_iotbus_spi_open_close_p_multi_handler();
	itc_systemio_iotbus_spi_open_close_p_modes();
	itc_systemio_iotbus_spi_open_close_n_invalid_bus();
	itc_systemio_iotbus_spi_open_close_n_invalid_bpw();
	itc_systemio_iotbus_spi_open_close_n_invalid_frequecy();
	itc_systemio_iotbus_spi_write_recv_trasfer_p();
	return 0;
}
