...
int utc_i2c_main(void)
{
	utc_i2c_init_p();
	utc_i2c_init_n();
	utc_i2c_set_frequency_n();
	utc_i2c_set_frequency_p_IOTBUS_I2C_FAST();
	utc_i2c_set_frequency_p_IOTBUS_I2C_HIGH();
	utc_i2c_set_frequency_p_IOTBUS_I2C_STD();
	utc_i2c_set_address_p();
	utc_i2c_set_address_n();
	utc_i2c_write_p();
	utc_i2c_write_n();
	utc_i2c_read_p();
	utc_i2c_read_n();
