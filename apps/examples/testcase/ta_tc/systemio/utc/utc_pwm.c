...
static void utc_pwm_open_n(void)
{
...
int utc_pwm_main(void)
{
	utc_pwm_open_p();
	utc_pwm_open_n();
	utc_pwm_set_duty_cycle_p();
	utc_pwm_set_duty_cycle_n();
	utc_pwm_get_duty_cycle_p();
	utc_pwm_get_duty_cycle_n();
	utc_pwm_set_period_p();
	utc_pwm_set_period_n();
	utc_pwm_get_period_p();
	utc_pwm_get_period_n();
	utc_pwm_set_enabled_p();
	utc_pwm_set_enabled_n();
	utc_pwm_is_enabled_p();
	utc_pwm_is_enabled_n();
	utc_pwm_close_n();
	utc_pwm_close_p();
