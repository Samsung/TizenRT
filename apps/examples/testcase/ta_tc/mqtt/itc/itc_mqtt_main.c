...
* @scenario         call mqtt_unsubscribe, mqtt_subscribe
...
/*
* @testcase             itc_mqtt_redeinit_client_p
...
void itc_mqtt_redeinit_client_p(void)
{
	int res;
	g_mqtt_client_handle = mqtt_init_client(&g_mqtt_client_config);
	TC_ASSERT_NEQ("mqtt_init_client", g_mqtt_client_handle, NULL);
...
void itc_mqtt_reconnect_p(void)
{
	int res;
	g_mqtt_client_handle = mqtt_init_client(&g_mqtt_client_config);
	TC_ASSERT_NEQ("mqtt_init_client", g_mqtt_client_handle, NULL);
...
/*
* @testcase             itc_mqtt_redisconnect_p
...
void itc_mqtt_redisconnect_p(void)
{
	int res;
	g_mqtt_client_handle = mqtt_init_client(&g_mqtt_client_config);
	TC_ASSERT_NEQ("mqtt_init_client", g_mqtt_client_handle, NULL);
...
/*
* @testcase         itc_mqtt_resubscribe_p
...
void itc_mqtt_resubscribe_p(void)
{
	int res;
	g_mqtt_client_handle = mqtt_init_client(&g_mqtt_client_config);
	TC_ASSERT_NEQ("mqtt_init_client", g_mqtt_client_handle, NULL);
...
/*
* @testcase         itc_mqtt_reunsubscribe_p
...
void itc_mqtt_reunsubscribe_p(void)
{
	int res;
	g_mqtt_client_handle = mqtt_init_client(&g_mqtt_client_config);
	TC_ASSERT_NEQ("mqtt_init_client", g_mqtt_client_handle, NULL);
...
/*
* @testcase         itc_mqtt_api_success_ratio
* @brief            success ratio for all api
* @scenario         success ratio for all api
* @apicovered       none
* @precondition     none
* @postcondition    none
*/

void itc_mqtt_api_success_ratio(void)
{
	int res;
	int i;
	float init_cnt = 0.0f;
...
/*
* @testcase         itc_mqtt_publish_performance
...
void itc_mqtt_publish_performance(void)
{
	double average = 0.0f;
...
/*
* @testcase         itc_mqtt_subscribe_performance
...
void itc_mqtt_subscribe_performance(void)
{
	double average = 0.0f;
	struct timeval start;
	struct timeval end;
...
/*
* @testcase         itc_mqtt_pub_zero_len_msg
* @brief            sending empty message
...
void itc_mqtt_pub_zero_len_msg(void)
{
	int res;
	char msg[] = "";
	g_mqtt_client_handle = mqtt_init_client(&g_mqtt_client_config);
...
static int mqtt_itc(int arc, FAR char *argv[])
{
	...
	if (res < 0) {
		...
		itc_mqtt_resubscribe_p();
		itc_mqtt_reunsubscribe_p();
		itc_mqtt_publish_performance();
		itc_mqtt_api_success_ratio();
		itc_mqtt_subscribe_performance();
		itc_mqtt_pub_zero_len_msg();
		itc_mqtt_redeinit_client_p();
		itc_mqtt_reconnect_p();
		itc_mqtt_redisconnect_p();
		_itc_mqtt_deinit();
	}
