...
#else							/* NEED_AP_MLME */
static inline void hostapd_free_hw_features(struct hostapd_hw_modes *hw_features, size_t num_hw_features)
{
}
...
static inline int hostapd_prepare_rates(struct hostapd_iface *iface, struct hostapd_hw_modes *mode)
{
	return 0;
}
