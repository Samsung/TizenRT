...
#define WPA_CTRL_FIFO_DEV_CFM CONFIG_WPA_CTRL_FIFO_DEV_CFM
#define WPA_CTRL_FIFO_DEV_GLOBAL_REQ CONFIG_WPA_CTRL_FIFO_DEV_GLOBAL_REQ
#define WPA_CTRL_FIFO_DEV_GLOBAL_CFM CONFIG_WPA_CTRL_FIFO_DEV_GLOBAL_CFM
#define WPA_MONITOR_FIFO_DEV CONFIG_WPA_MONITOR_FIFO_DEV
#else
#error "Wrong compiler defines"
#endif
