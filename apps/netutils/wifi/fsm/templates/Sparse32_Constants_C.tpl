...
__FSM_VAR(ConstQualifier)
static const FSM_SPARSE32_TRANSITION_T __FSM_NAME_LOWER_transitions[] = {
...
__FSM_VAR(StateSep)__FSM_NO_NEWLINE
  { BUILD_TRANSITION32(__FSM_VAR(EventPrefix)__FSM_EVENT_NAME_UPPER,  __FSM_PAD_EVENT __FSM_VAR(ActionNumPrefix)__FSM_ACTION_NAME, __FSM_PAD_ACTION __FSM_VAR(StatePrefix)__FSM_NEXT_STATE) }__FSM_NO_NEWLINE
__FSM_SET_VAR(StateSep, ",\n")
__FSM_END_FOR
__FSM_END_FOR
...
__FSM_VAR(ConstQualifier)
static const FSM_SPARSE32_STATES_T __FSM_NAME_LOWER_states[__FSM_VAR(StatePrefix)ST_MAX+1] = {
...
__FSM_VAR(ConstQualifier)
const FSM_SPARSE32_DEFINITION_T __FSM_NAME_LOWER_fsm =
{
    (const FSM_SPARSE32_STATES_T *) __FSM_NAME_LOWER_states,
...
COMPILE_TIME_ASSERT(1<<TRANSITION32_NEW_STATE_BITS >= __FSM_VAR(Stateprefix)ST_MAX, new_state_bits_overflow);
COMPILE_TIME_ASSERT(1<<TRANSITION32_ACTION_BITS >= __FSM_VAR(ActionNumPrefix)MAX, action_bits_overflow);
