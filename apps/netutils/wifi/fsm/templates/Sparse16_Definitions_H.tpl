...
__FSM_FOR_STATES
#define __FSM_VAR(StatePrefix)__FSM_STATE_NAME_UPPER __FSM_PAD_STATE((fsm16_state_t) __FSM_STATE_NO)
__FSM_END_FOR
__FSM_END_MARKER
...
__FSM_FOR_ACTIONS
#define __FSM_VAR(ActionNumPrefix)__FSM_ACTION_NAME_LOWER __FSM_PAD_ACTION((fsm16_action_t) __FSM_ACTION_NO)
__FSM_END_FOR
#define __FSM_VAR(ActionNumPrefix)NULL (FSM16_ACTION_NULL)
__FSM_END_MARKER

/* State machine definition */
__FSM_MARKER(FSM_DEFINITION)
extern const FSM_SPARSE16_DEFINITION_T __FSM_NAME_LOWER_fsm;
__FSM_END_MARKER
