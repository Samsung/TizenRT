...
For using menuconfig, there are few mandatory packages to be installed, Refer [kconfig-frontend installation](docs/HowtoInstallKconfigFrontend.md) to use *menuconfig*.
