...
int ist415_cmtest_internal(struct ist415_dev_s *dev, int *result)
{
	int16_t *buf16;
	int ret = 0;
	buf16 = (int16_t *)kmm_malloc(dev->mtl_node_len * sizeof(int16_t));
...
int ist415_jittertest_internal(struct ist415_dev_s *dev, int *result)
{
	int16_t *buf16;
	int ret = 0;
	buf16 = (int16_t *)kmm_malloc(dev->mtl_node_len * sizeof(int16_t));
