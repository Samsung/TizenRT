...
static const unsigned int NDP_NOTIFICATION_ERRORS =
	...
	| SYNTIANT_NDP_NOTIFICATION_DELAY_ERROR
	| SYNTIANT_NDP_NOTIFICATION_INVALID_DSP_ADDR
	| SYNTIANT_NDP_NOTIFICATION_UNKNOWN_MIC_STATE
	| SYNTIANT_NDP_NOTIFICATION_INVALID_ARGS;
