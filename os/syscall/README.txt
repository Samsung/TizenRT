...
but also for the generation of symbol tables.  See os/tools/README.txt
and build/output/libraries/README.txt for further information.
...
=========
  ...
  output.  See os/tools/README.txt for additional information.
