...
#define AMEBASMART_DRAM_OFFSET         0x00100000
...
#define AMEBASMART_DRAM_PBASE          (AMEBASMART_DRAM_PSECTION + AMEBASMART_DRAM_OFFSET) // Starting base from PSRAM for BL33 (0x60100000)
#define AMEBASMART_DRAM_VBASE          (AMEBASMART_DRAM_VSECTION + AMEBASMART_DRAM_OFFSET) // Starting base from PSRAM for BL33 (0x60100000)
