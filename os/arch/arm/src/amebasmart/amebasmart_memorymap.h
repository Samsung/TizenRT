/****************************************************************************
 * arch/arm/src/amebasmart/amebasmart_memorymap.h
 *
...
#ifndef __ARCH_ARM_SRC_AMEBASMART_AMEBASMART_MEMORYMAP_H
#define __ARCH_ARM_SRC_AMEBASMART_AMEBASMART_MEMORYMAP_H
 ...
 *    to that address, and
 *
 *    For the case of CONFIG_ARCH_LOWVECTORS=y, defined.  The AmebaSmart boot-up
...
#if defined(CONFIG_AMEBASMART_MMDC) && !defined(CONFIG_AMEBASMART_BOOT_SDRAM)
...
extern struct section_mapping_s g_section_mapping[];
...
#endif /* __ARCH_ARM_SRC_AMEBASMART_AMEBASMART_MEMORYMAP_H */
