...
static int pl011_ioctl(FAR struct uart_dev_s *dev, int cmd, unsigned long arg);
 ...
 *
 * Description:
 *   see os/arch/arm/src/qemu-virt/qemu_pl011.h
 *
 ***************************************************************************/
 ...
 *
 * Description:
 *   Return the active console device so common console flush code can
 *   drain buffered output during abort paths.
 *
 ***************************************************************************/
 ...
 *
 * Description:
 *   Output one byte directly to the serial console.
 *
 ***************************************************************************/
