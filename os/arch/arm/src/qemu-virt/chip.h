...
#define TIZENRT_TEXT_VADDR      CONFIG_FLASH_VSTART
#define TIZENRT_TEXT_PADDR      CONFIG_FLASH_START_ADDR
#define TIZENRT_TEXT_PEND       ((CONFIG_FLASH_END_ADDR + 0x000fffff) & 0xfff00000)
