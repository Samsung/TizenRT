 ...
 *
 * Description:
 *   Save the current cpu context in the task TCB context. MPU's region start
 * address is the input address that is passed to this function.
 *
 * Full prototype is:
