...
#ifndef __IMXRT_DCDC_H__
#define __IMXRT_DCDC_H__
...
*/
void imxrt_dcdc_init(DCDC_Type *base);
...
* @param base DCDC peripheral base address.
*/
void imxrt_dcdc_deinit(DCDC_Type *base);
...
*/
uint32_t imxrt_dcdc_getstatusflags(DCDC_Type *base);
 ...
 */
static inline void imxrt_dcdc_enableoutputrangecomparator(DCDC_Type *base, bool enable)
{
	if (enable) {
...
*/
void imxrt_dcdc_setclocksource(DCDC_Type *base, dcdc_clock_source_t clockSource);
...
*/
void imxrt_dcdc_getdefaultdetectionconfig(dcdc_detection_config_t *config);
...
*/
void imxrt_dcdc_getdefaultlowpowerconfig(dcdc_low_power_config_t *config);
...
* @param config Pointer to configuration structure. See to "dcdc_low_power_config_t".
*/
void imxrt_dcdc_setlowpowerconfig(DCDC_Type *base, const dcdc_low_power_config_t *config);
...
*/
void imxrt_dcdc_resetcurrentalertsignal(DCDC_Type *base, bool enable);
...
*/
static inline void imxrt_dcdc_setbandgapvoltagetrimvalue(DCDC_Type *base, uint32_t trimValue)
{
...
*/
void imxrt_dcdc_getdefaultloopcontrolconfig(dcdc_loop_control_config_t *config);
...
* @param config Pointer to configuration structure. See to "dcdc_loop_control_config_t".
*/
void imxrt_dcdc_setloopcontrolconfig(DCDC_Type *base, const dcdc_loop_control_config_t *config);
 ...
 */
void imxrt_dcdc_setminpowerconfig(DCDC_Type *base, const dcdc_min_power_config_t *config);
...
*/
static inline void imxrt_dcdc_setlpcomparatorbiasvalue(DCDC_Type *base, dcdc_comparator_current_bias_t biasVaule)
{
	base->REG1 &= ~DCDC_REG1_LP_CMP_ISRC_SEL_MASK;
	base->REG1 |= DCDC_REG1_LP_CMP_ISRC_SEL(biasVaule);
}

static inline void imxrt_dcdc_locktargetvoltage(DCDC_Type *base)
{
...
*/
void imxrt_dcdc_adjusttargetvoltage(DCDC_Type *base, uint32_t VDDRun, uint32_t VDDStandby);
...
* @param enable Enable the feature or not.
*/
static inline void imxrt_dcdc_enableadjustdelay(DCDC_Type *base, bool enable)
{
	if (enable) {
...
* @param enable Enable the feature or not.
*/
static inline void imxrt_dcdc_enableimprovetransition(DCDC_Type *base, bool enable)
{
    if (enable) {
...
* @param base DCDC peripheral base address.
*/
void imxrt_dcdc_bootintodcm(DCDC_Type *base);
...
* @param base DCDC peripheral base address.
*/
void imxrt_dcdc_bootintoccm(DCDC_Type *base);

#if defined(__cplusplus)
}
#endif

#endif /* __IMXRT_DCDC_H__ */
