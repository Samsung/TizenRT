 ...
 * @param base GPT peripheral base address.
 */
static inline void imxrt_gpt_softwarereset(GPT_Type *base)
{
 ...
 */
static inline void imxrt_gpt_setclocksource(GPT_Type *base, gpt_clock_source_t source)
{
 ...
 */
static inline gpt_clock_source_t imxrt_gpt_getclocksource(GPT_Type *base)
{
 ...
 */
static inline void imxrt_gpt_setclockdivider(GPT_Type *base, uint32_t divider)
{
 ...
 */
static inline uint32_t imxrt_gpt_getclockdivider(GPT_Type *base)
{
 ...
 */
static inline void imxrt_gpt_setoscclockdivider(GPT_Type *base, uint32_t divider)
{
 ...
 */
static inline uint32_t imxrt_gpt_getoscclockdivider(GPT_Type *base)
{
 ...
 * @param base GPT peripheral base address.
 */
static inline void imxrt_gpt_starttimer(GPT_Type *base)
{
 ...
 */
static inline uint32_t imxrt_gpt_getcurrenttimercount(GPT_Type *base)
{
	return base->CNT;
}
 ...
 */
static inline gpt_input_operation_mode_t imxrt_gpt_getinputoperationmode(GPT_Type *base, gpt_input_capture_channel_t channel)
{
	assert(channel <= kGPT_InputCapture_Channel2);
 ...
 */
static inline uint32_t imxrt_gpt_getinputcapturevalue(GPT_Type *base, gpt_input_capture_channel_t channel)
{
	assert(channel <= kGPT_InputCapture_Channel2);
 ...
 */
static inline void imxrt_gpt_setoutputcomarevalue(GPT_Type *base, gpt_output_compare_channel_t channel, uint32_t value)
{
	assert(channel <= kGPT_OutputCompare_Channel3);
 ...
 */
static inline uint32_t imxrt_gpt_getoutputcomparevalue(GPT_Type *base, gpt_output_compare_channel_t channel)
{
	assert(channel <= kGPT_OutputCompare_Channel3);
 ...
 * @param channel GPT output compare channel (see @ref gpt_output_compare_channel_t typedef enumeration).
 */
static inline void imxrt_gpt_forceoutput(GPT_Type *base, gpt_output_compare_channel_t channel)
{
	assert(channel <= kGPT_OutputCompare_Channel3);
 ...
 */
static inline void imxrt_gpt_enableinterrupts(GPT_Type *base, uint32_t mask)
{
	base->IR |= mask;
}
 ...
 *                enumeration ::gpt_interrupt_enable_t
 */
static inline void imxrt_gpt_disableinterrupts(GPT_Type *base, uint32_t mask)
{
	base->IR &= ~mask;
}
 ...
 *         enumeration ::gpt_interrupt_enable_t
 */
static inline uint32_t imxrt_gpt_getenabledinterrupts(GPT_Type *base)
{
 ...
 */
static inline uint32_t imxrt_gpt_getstatusflags(GPT_Type *base, gpt_status_flag_t flags)
{
 ...
 * @param flags GPT status flag mask (see @ref gpt_status_flag_t for bit definition).
 */
static inline void imxrt_gpt_clearstatusflags(GPT_Type *base, gpt_status_flag_t flags)
{
	base->SR = flags;
}
