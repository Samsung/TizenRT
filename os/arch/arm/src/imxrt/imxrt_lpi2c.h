 ...
 *
 ****************************************************************************/
#ifndef _IMXRT_LPI2C_H_
#define _IMXRT_LPI2C_H_
 ...
 *   masterConfig User provided peripheral configuration. Use LPI2C_MasterGetDefaultConfig() to get a set of
 *                defaults
...
/****************************************************************************
 * Function: imxrt_lpi2c_checkforbusybus
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterreset
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterenable
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastergetstatusflags
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns State of the status flags:
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterclearstatusflags
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   statusMask A bitmask of status flags that are to be cleared. The mask is composed of
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterenableinterrupts
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   interruptMask Bit mask of interrupts to enable. See #_lpi2c_master_flags for the set
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterdisableinterrupts
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   interruptMask Bit mask of interrupts to disable. See #_lpi2c_master_flags for the set
 *                 of constants that should be OR'd together to form the bit mask.
 *
 * Returned Value:
 *   None
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastergetenableinterrupts
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns A bitmask composed of #_lpi2c_master_flags enumerators OR'd together to indicate the
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterenabledma
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastergettxfifoaddress
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns The LPI2C Master Transmit Data Register address.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastergetrxfifoaddress
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns The LPI2C Master Receive Data Register address.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastersetwatermarks
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   txWords Transmit FIFO watermark value in words. The #kLPI2C_MasterTxReadyFlag flag is set whenever
 ...
 *   rxWords Receive FIFO watermark value in words. The #kLPI2C_MasterRxReadyFlag flag is set whenever
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastergetfifocounts
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   txCount[out] Pointer through which the current number of words in the transmit FIFO is returned.
 *                Pass NULL if this value is not required.
 *   rxCount[out] Pointer through which the current number of words in the receive FIFO is returned.
 *                Pass NULL if this value is not required.
 *
 * Returned Value:
 *   None
...
/****************************************************************************
 * Function: imxrt_lpi2c_mastergetbusidlestate
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns true Bus is busy.
 *   Returns false Bus is idle.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Function: imxrt_lpi2c_masterrepeatedstart
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns #kStatus_Success Repeated START signal and address were successfully enqueued in the transmit FIFO.
 *   Returns #kStatus_LPI2C_Busy Another master is currently utilizing the bus.
 *
 ****************************************************************************/
 ...
 *   Returns #kStatus_LPI2C_Busy Another master is currently utilizing the bus.
 *   Returns #kStatus_LPI2C_FifoError FIFO under run or over run.
...
/****************************************************************************
 * Function: imxrt_mastertransfercreatehandle
 *
 * Description:
 ...
 *   Returns #kStatus_LPI2C_Idle There is not a non-blocking transaction currently in progress.
 *
 ****************************************************************************/
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   slaveConfig User provided peripheral configuration. Use LPI2C_SlaveGetDefaultConfig() to get a set of defaults
 *               that you can override.
...
/****************************************************************************
 * Function: imxrt_lpi2c_slavereset
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_slaveenable
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_slavegetstatusflags
 *
 * Description:
...
/****************************************************************************
 * Function: imxrt_lpi2c_slaveclearstatusflags
 *
 * Description:
 ...
 *              imxrt_lpi2c_slavegetstatusflags().
 *
 * Returned Value:
 *   None
 *
...
/****************************************************************************
 * Function: imxrt_lpi2c_slaveenableinterrupts
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   interruptMask Bit mask of interrupts to enable. See #_lpi2c_slave_flags for the set
 *                 of constants that should be OR'd together to form the bit mask.
 *
 * Returned Value:
 *   None
...
/****************************************************************************
 * Function: imxrt_lpi2c_slavedisableinterrupts
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   interruptMask Bit mask of interrupts to disable. See #_lpi2c_slave_flags for the set
 *                 of constants that should be OR'd together to form the bit mask.
 *
 * Returned Value:
 *   None
...
/****************************************************************************
 * Function: imxrt_lpi2c_slavegetenabledinterrupts
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns A bitmask composed of #_lpi2c_slave_flags enumerators OR'd together to indicate the
 *           set of enabled interrupts.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Function: imxrt_lpi2c_slaveenabledma
 *
 * Description:
 ...
 * Input Parameters:
 *   base The LPI2C peripheral base address.
 *   enableAddressValid Enable flag for the address valid DMA request. Pass true for enable, false for disable.
...
/****************************************************************************
 * Function: imxrt_lpi2c_slavegetbusidlestate
 *
 * Description:
 *   brief Returns whether the bus is idle.
 *
...
/****************************************************************************
 * Function: imxrt_lpi2c_slavetransmitack
 *
 * Description:
 ...
 *
 * Returned Value:
 *   Returns The 8-bit address matched by the LPI2C slave. Bit 0 contains the R/w direction bit, and
