 ...
 */
static uint32_t imxrt_dcdc_getinstance(DCDC_Type *base);
...
#if !(defined(FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL) && FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL)
	/* Enable the clock. */
	imxrt_clock_enableclock(s_dcdcClocks[imxrt_dcdc_getinstance(base)]);
#endif /* FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL */
}
...
#if !(defined(FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL) && FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL)
	/* Disable the clock. */
	imxrt_clock_disableclock(s_dcdcClocks[imxrt_dcdc_getinstance(base)]);
#endif /* FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL */
}
