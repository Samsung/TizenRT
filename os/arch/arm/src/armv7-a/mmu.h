...
#define MMU_APP_L1_RWX         	(PMD_TYPE_SECT | PMD_SECT_AP_RW01 | PMD_CACHEABLE | \
...
#define MMU_APP_L2_RWX		(PTE_TYPE_SMALL | PMD_CACHEABLE | PTE_AP_RW01 | PTE_S)
#else
#define MMU_APP_L2_RW		(PTE_TYPE_SMALL | PMD_CACHEABLE | PTE_AP_RW01 | PTE_SMALL_XN)
#define MMU_APP_L2_RWX		(PTE_TYPE_SMALL | PMD_CACHEABLE | PTE_AP_RW01)
#endif
...
.macro cp15_disable_mmu, scratch mrc p15, 0, \scratch, c1, c0, 0 bic \ scratch, \scratch,
#1
	   mcr p15, 0, \scratch, c1, c0, 0.endm
	   /****************************************************************************
	    ...
	    *
	    ****************************************************************************/
	   .macro cp15_invalidate_tlbs, scratch mcr p15, 0, \scratch, c8, c7, 0	/* TLBIALL */
	   .endm
	   /****************************************************************************
	    ...
	    *
	    ****************************************************************************/
	   .macro cp15_invalidate_tlb_bymva, vaddr dsb
	    ...
	    *
	    ****************************************************************************/
	   .macro cp15_wrdacr, dacr mcr p15, 0, \dacr, c3, c0, 0 nop nop nop nop nop nop nop nop.endm
	   /****************************************************************************
	    * Name: cp15_wrttb
	    *
	    * Description:
	    ...
	    *
	    ****************************************************************************/
	   .macro cp15_wrttb, ttb, scratch mcr p15, 0, \ttb, c2, c0, 0 nop nop nop nop nop nop nop nop mov \ scratch,
#0x0
	   mcr p15, 0, \scratch, c2, c0, 2.endm
	   /****************************************************************************
	    * Name: pg_l2map
	    *
	    * Description:
...
#0
	    ...
	    ****************************************************************************/
#ifdef CONFIG_PAGING
	   .macro pg_l1span, l1, l2, npages, ppage, mmuflags, tmp b 2f 1:
...
#4
	   ...
	   add \ l2, \l2,
#PT_SIZE						/* Next L2 page table start address */
