...
#if BK_SUPPLICANT
#define WPA_LOGI(...) BK_WIFI_LOGI("wpa", ##__VA_ARGS__)
#define WPA_LOGW(...) BK_WIFI_LOGW("wpa", ##__VA_ARGS__)
#define WPA_LOGE(...) BK_WIFI_LOGE("wpa", ##__VA_ARGS__)
#define WPA_LOGD(...) BK_WIFI_LOGD("wpa", ##__VA_ARGS__)
#endif
 ...
 */
#define wpa_printf(level, fmt, ...)  wpa_dbg(NULL, level, fmt, ##__VA_ARGS__)
