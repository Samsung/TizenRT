...
enum {
	...
	PRISM2_HOSTAPD_UPDATE_FT_IES,
#endif
	PRISM2_HOSTAPD_ROC,
	PRISM2_HOSTAPD_CANCEL_ROC,
	PRISM2_HOSTAPD_SIGNAL_MONITOR,
	PRISM2_HOSTAPD_GET_SIGNAL_POLL,
};
...
struct prism2_hostapd_param {
	...
	union {
		...
		struct {
			u16 aid;
			u16 capability;
			u8 supp_rates[WLAN_SUPP_RATES_MAX];
			u8 plink_state;
			u8 set;
...
#define CONFIG_RX_DCM_DISABLE                 1
