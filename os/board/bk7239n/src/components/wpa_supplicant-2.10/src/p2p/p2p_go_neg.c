...
#ifdef BK_SUPPLICANT
			/*
			 * Transmission of GO NEG RESP and receiption of GO NEG CONFIRM
			 * will fail if p2p listen is about to end, so here we stop p2p find 
			 * (force stop listen) and start a new listen process to ensure success of 
			 * GO NEG RESP frame TX and GO NEG CONFIRM RX
			 */
