...
#ifdef BK_SUPPLICANT
#define STA_HASH_SIZE 8
#define STA_HASH(sta) (sta[5] & (STA_HASH_SIZE - 1))
#else
...
#define STA_HASH(sta) (sta[5])
	 ...
	 */
#ifdef BK_SUPPLICANT
#define AID_WORDS	1//((CFG_STA_MAX + 31) / 32)
#else
...
#ifdef BK_SUPPLICANT
	/* another csa request when in CSA */
	struct csa_settings *csa_settings_pending;
#endif
