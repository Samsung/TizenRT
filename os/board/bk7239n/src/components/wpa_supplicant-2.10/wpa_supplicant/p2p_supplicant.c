...
static void wpas_p2p_group_started(struct wpa_supplicant *wpa_s,
				   ...
				   const char *extra)
{
	const char *ssid_txt __maybe_unused;
	char psk_txt[65];
...
static void p2p_go_configured(void *ctx, void *data)
{
	...
	struct wpa_ssid *ssid __maybe_unused;
			   ...
			   int new_device)
{
	...
	char devtype[WPS_DEV_TYPE_BUFSIZE] __maybe_unused;
