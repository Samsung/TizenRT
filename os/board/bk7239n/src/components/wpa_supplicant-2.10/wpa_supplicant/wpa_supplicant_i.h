...
#define WILDCARD_SSID_SCAN ((struct wpa_ssid *) 1)
	...
	struct os_reltime scan_trigger_time, scan_start_time,scan_use_time;
...
#if defined(BK_SUPPLICANT) && defined(CONFIG_WPA_FIXED_SCAN_INTERVAL)
...
#define MAX_SCAN_ID 4
	...
	int auth_alg;
	u16 last_owe_group;
#if defined(CONFIG_SME) || defined(CONFIG_IEEE80211W) || defined(CONFIG_SAE) || defined(CONFIG_IEEE80211R)
	struct {
#ifdef BK_SUPPLICANT
		int retry_count;
#endif
#if defined(CONFIG_SME) || defined(CONFIG_IEEE80211R)
		u8 ssid[SSID_MAX_LEN];
		size_t ssid_len;
		int freq;
		...
		int auth_alg;
		int proto;
#endif /* CONFIG_SME || CONFIG_IEEE80211R*/
