...
int printf_ex(const char *fmt, ...);

#define mbedtls_printf  printf_ex//printf
//#define mbedtls_printf(const char *fmt, ...)  (void)(const char *fmt, ...)
#endif /* CONFIG_MBEDTLS_ACCELERATOR */
