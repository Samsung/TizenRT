    ...
    size_t *shared_secret_length)
{
    ...
    /* CVE-2026-34872: validate the peer's public key to ensure contributory
     * behavior in FFDH. Without this check, the remote party can force the
     * shared secret into a small subgroup, effectively controlling the secret.
     *
