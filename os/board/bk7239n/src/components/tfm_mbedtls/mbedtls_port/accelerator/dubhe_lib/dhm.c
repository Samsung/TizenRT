                    ...
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    ...
    {
        MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod( &ctx->Vi, &ctx->Vi, &ctx->Vi, &ctx->P ) );
        MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod( &ctx->Vf, &ctx->Vf, &ctx->Vf, &ctx->P ) );
                     ...
                     void *p_rng )
{
    ...
    MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod( &GYb, &ctx->GY, &ctx->Vi, &ctx->P ) );
    ...
    MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod( &ctx->K, &ctx->K, &ctx->Vf, &ctx->P ) );
