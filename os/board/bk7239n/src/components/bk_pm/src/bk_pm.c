...
void bk_pm_enter_sleep(void)
{
	...
	PM_LOGD("bk_pm_enter_sleep: sleep_ticks=%d (weak default)\n", sleep_ticks);
...
{
	PM_LOGD("bk_pm_mcu_pm_ctrl: power_state=%d (weak default)\n", power_state);
	return BK_OK;
}

uint32_t __attribute__((weak)) bk_pm_mcu_pm_state_get(void)
{
	PM_LOGD("bk_pm_mcu_pm_state_get: returning 0x1 (weak default)\n");
...
{
	PM_LOGD("bk_pm_sleep_mode_set: sleep_mode=%d (weak default)\n", sleep_mode);
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_wakeup_source_set: wakeup_source=%d, source_param=%p (weak default)\n", wakeup_source, source_param);
	return BK_OK;
}

pm_wakeup_source_e __attribute__((weak)) bk_pm_deep_sleep_wakeup_source_get(void)
{
	PM_LOGD("bk_pm_deep_sleep_wakeup_source_get: returning PM_WAKEUP_SOURCE_INT_NONE (weak default)\n");
	return PM_WAKEUP_SOURCE_INT_NONE;
}

pm_wakeup_source_e __attribute__((weak)) bk_pm_exit_low_vol_wakeup_source_get(void)
{
	PM_LOGD("bk_pm_exit_low_vol_wakeup_source_get: returning PM_WAKEUP_SOURCE_INT_NONE (weak default)\n");
	return PM_WAKEUP_SOURCE_INT_NONE;
}

bk_err_t __attribute__((weak)) bk_pm_exit_low_vol_wakeup_source_clear(void)
{
	PM_LOGD("bk_pm_exit_low_vol_wakeup_source_clear: (weak default)\n");
	return BK_OK;
}

bk_err_t __attribute__((weak)) bk_pm_exit_low_vol_wakeup_source_set(void)
{
	PM_LOGD("bk_pm_exit_low_vol_wakeup_source_set: (weak default)\n");
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_module_vote_sleep_ctrl: module=%d, sleep_state=%d, sleep_time=%d (weak default)\n", module, sleep_state, sleep_time);
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_module_vote_power_ctrl: module=%d, power_state=%d (weak default)\n", module, power_state);
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_module_vote_cpu_freq: module=%d, cpu_freq=%d (weak default)\n", module, cpu_freq);
	return BK_OK;
}

pm_cpu_freq_e __attribute__((weak)) bk_pm_module_current_cpu_freq_get(pm_dev_id_e module)
{
	PM_LOGD("bk_pm_module_current_cpu_freq_get: module=%d, returning PM_CPU_FRQ_DEFAULT (weak default)\n", module);
	return PM_CPU_FRQ_DEFAULT;
}

pm_cpu_freq_e __attribute__((weak)) bk_pm_current_max_cpu_freq_get(void)
{
	PM_LOGD("bk_pm_current_max_cpu_freq_get: returning PM_CPU_FRQ_DEFAULT (weak default)\n");
	return PM_CPU_FRQ_DEFAULT;
}

bk_err_t __attribute__((weak)) bk_pm_clock_ctrl(pm_dev_clk_e module, pm_dev_clk_pwr_e clock_state)
{
	PM_LOGD("bk_pm_clock_ctrl: module=%d, clock_state=%d (weak default)\n", module, clock_state);
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_lp_vol_set: lp_vol=%d (weak default)\n", lp_vol);
	return BK_OK;
}

uint32_t __attribute__((weak)) bk_pm_lp_vol_get(void)
{
	PM_LOGD("bk_pm_lp_vol_get: returning 0 (weak default)\n");
	return 0; /* 默认0.6V */
}

bk_err_t __attribute__((weak)) bk_pm_rf_tx_vol_set(uint32_t tx_vol)
{
	PM_LOGD("bk_pm_rf_tx_vol_set: tx_vol=%d (weak default)\n", tx_vol);
	return BK_OK;
}

uint32_t __attribute__((weak)) bk_pm_rf_tx_vol_get(void)
{
	PM_LOGD("bk_pm_rf_tx_vol_get: returning 0 (weak default)\n");
	return 0; /* 默认1.25V */
}

bk_err_t __attribute__((weak)) bk_pm_rf_rx_vol_set(uint32_t rx_vol)
{
	PM_LOGD("bk_pm_rf_rx_vol_set: rx_vol=%d (weak default)\n", rx_vol);
	return BK_OK;
}

uint32_t __attribute__((weak)) bk_pm_rf_rx_vol_get(void)
{
	PM_LOGD("bk_pm_rf_rx_vol_get: returning 0 (weak default)\n");
	return 0; /* 默认1.25V */
}
...
{
	PM_LOGD("bk_pm_lpo_src_set: lpo_src=%d (weak default)\n", lpo_src);
	return BK_OK;
}

pm_lpo_src_e __attribute__((weak)) bk_pm_lpo_src_get(void)
{
	PM_LOGD("bk_pm_lpo_src_get: returning PM_LPO_SRC_X32K (weak default)\n");
...
{
	PM_LOGD("bk_pm_sleep_register_cb: sleep_mode=%d, dev_id=%d (weak default)\n", sleep_mode, dev_id);
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_module_lv_sleep_state_get: module=%d, returning 0 (weak default)\n", module);
	return 0;
}

bk_err_t __attribute__((weak)) bk_pm_module_lv_sleep_state_clear(pm_dev_id_e module)
{
	PM_LOGD("bk_pm_module_lv_sleep_state_clear: module=%d (weak default)\n", module);
	return BK_OK;
}
...
{
	PM_LOGD("bk_pm_mem_auto_power_down_state_get: returning PM_MEM_AUTO_CTRL_DISABLE (weak default)\n");
	return PM_MEM_AUTO_CTRL_DISABLE;
}

bk_err_t __attribute__((weak)) bk_pm_mem_auto_power_down_state_set(pm_mem_auto_ctrl_e value)
{
	PM_LOGD("bk_pm_mem_auto_power_down_state_set: value=%d (weak default)\n", value);
	return BK_OK;
}
