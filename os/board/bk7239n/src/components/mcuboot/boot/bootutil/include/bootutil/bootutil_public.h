...
/**
 * @brief get the address of saving the xip status
 *
 * get the address of saving the xip status.
 *
 * @attention
 *  - This API is used to get the address of saving the xip status
 * @param
 * -area id:0x0:AREA_A;0X1:AREA_B
 * @return
 * - 1 : the address of saving the xip status
 */
