...
#define PSA_LOGI(...) BK_LOGI("psa", ##__VA_ARGS__)
#define PSA_LOGW(...) BK_LOGW("psa", ##__VA_ARGS__)
#define PSA_LOGE(...) BK_LOGE("psa", ##__VA_ARGS__)
#define PSA_LOGD(...) BK_LOGD("psa", ##__VA_ARGS__)
...
#define MBEDTLS_PLATFORM_PRINTF_MACRO        PSA_LOGD /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correctly zero-terminate the buffer! */
