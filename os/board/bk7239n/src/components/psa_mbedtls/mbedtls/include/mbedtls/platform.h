...
#define MBEDTLS_PLATFORM_STD_CALLOC   kmm_calloc /**< The default \c calloc function to use. */
#endif
#if !defined(MBEDTLS_PLATFORM_STD_FREE)
#define MBEDTLS_PLATFORM_STD_FREE       kmm_free /**< The default \c free function to use. */
#endif
