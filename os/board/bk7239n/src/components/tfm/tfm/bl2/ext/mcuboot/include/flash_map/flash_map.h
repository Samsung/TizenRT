...
uint32_t flash_area_update_dbus(const struct flash_area *area, uint32_t off, const void *src, uint32_t len);

int flash_area_read_dbus(const struct flash_area *area, uint32_t off, void *dst, uint32_t len);
