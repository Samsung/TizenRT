...
#if 1
//key and certifications : first 32 stored in Flash, next 32 stored in RAM
#define CONFIG_SS_KEY_INDEX_MAX   (64)
#define CONFIG_SS_CERT_INDEX_MAX  (64)
#define CONFIG_SS_DATA_INDEX_MAX  (33)
#define SS_RAM_INDEX_START        (4)  // Starting index for RAM storage
#else
#define CONFIG_SS_KEY_INDEX_MAX   (8)
#define CONFIG_SS_CERT_INDEX_MAX  (8)
#define CONFIG_SS_DATA_INDEX_MAX  (6)
#define SS_RAM_INDEX_START        (4)
#endif
