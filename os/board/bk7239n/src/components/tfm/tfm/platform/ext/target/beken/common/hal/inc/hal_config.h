 ...
 *          2. ECDSA_SHA1
 */
#define CAL_ENABLE_ECDSA                          1
#define CAL_ENABLE_HASH                           1
 ...
 *          1. AES-ECB
 */
#define CAL_ENABLE_CIPHER_MODE_ECB                0
 ...
 *          1. AES-CTR
 */
#define CAL_ENABLE_CIPHER_MODE_CTR                0

#if (CAL_ENABLE_CIPHER_MODE_ECB ||                   \
     CAL_ENABLE_CIPHER_MODE_CTR)
