...
int ecp_mode_cal( mbedtls_ecp_group_id id, mbedtls_mpi *N )
{
	int ret = 0;
...
static int ecp_mod_p192( mbedtls_mpi *N )
{
    ...
    mbedtls_mpi P;
    mbedtls_mpi_init( &P );
    P.p = (mbedtls_mpi_uint *)secp192r1_p;
    P.n = sizeof( secp192r1_p ) / sizeof( mbedtls_mpi_uint );
    MBEDTLS_MPI_CHK( mbedtls_mpi_mod_mpi( N, N, &P ) );

cleanup:
    mbedtls_mpi_free_handle( &P );
    return( ret );
}
...
static int ecp_mod_p224( mbedtls_mpi *N )
{
    ...
    mbedtls_mpi P;
    mbedtls_mpi_init( &P );
    P.p = (mbedtls_mpi_uint *)secp224r1_p;
    P.n = sizeof( secp224r1_p ) / sizeof( mbedtls_mpi_uint );
    MBEDTLS_MPI_CHK( mbedtls_mpi_mod_mpi( N, N, &P ) );
...
static int ecp_mod_p256( mbedtls_mpi *N )
{
    ...
    mbedtls_mpi P;
    mbedtls_mpi_init( &P );
    P.p = (mbedtls_mpi_uint *)secp256r1_p;
    P.n = sizeof( secp256r1_p ) / sizeof( mbedtls_mpi_uint );
    MBEDTLS_MPI_CHK( mbedtls_mpi_mod_mpi( N, N, &P ) );
...
static int ecp_mod_p384( mbedtls_mpi *N )
{
    ...
    mbedtls_mpi P;
    mbedtls_mpi_init( &P );
    P.p = (mbedtls_mpi_uint *)secp384r1_p;
    P.n = sizeof( secp384r1_p ) / sizeof( mbedtls_mpi_uint );
    MBEDTLS_MPI_CHK( mbedtls_mpi_mod_mpi( N, N, &P ) );
...
static int ecp_mod_p521( mbedtls_mpi *N )
{
    ...
    mbedtls_mpi P;
    mbedtls_mpi_init( &P );
    P.p = (mbedtls_mpi_uint *)secp521r1_p;
    P.n = sizeof( secp521r1_p ) / sizeof( mbedtls_mpi_uint );
    MBEDTLS_MPI_CHK( mbedtls_mpi_mod_mpi( N, N, &P ) );
