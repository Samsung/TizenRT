...
#if CONFIG_BK_BOOT
/* In order to support BL2 OTA, primary/recovery share the same version
 * number to prevent down-grade OTA.
 * */
#define HAL_OTP_PRIM_MNFT_VER_OFFSET (136)
#else
#define HAL_OTP_PRIM_MNFT_VER_OFFSET (140)
#endif

#define HAL_OTP_RECV_MNFT_VER_OFFSET (136)
#define HAL_OTP_FOTA_VER_OFFSET (128)

#ifdef CONFIG_SW_SHA384
#define HAL_OTP_SB_LONG_PK_HASH_OFFSET (384)
#define HAL_OTP_SB_LONG_PK_HASH_SIZE    48
#endif
...
#define HAL_OTP_RECV_MNFT_VER_SIZE (4)
