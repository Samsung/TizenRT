...
int mbedtls_get_otp_info( mbedtls_otp_info_t type, uint8_t *output, size_t size, uint32_t offset )
{
...
int mbedtls_set_otp_info( mbedtls_otp_info_t type, const uint8_t *input, size_t ilen, uint32_t offset )
{
