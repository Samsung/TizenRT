...
#define BK_ERR_I2C_NOT_INIT              ((int)(BK_ERR_I2C_BASE - 1)) /**< I2C driver not init */
#define BK_ERR_I2C_ID_NOT_INIT           ((int)(BK_ERR_I2C_BASE - 2)) /**< I2C id not init */
#define BK_ERR_I2C_SM_BUS_BUSY           ((int)(BK_ERR_I2C_BASE - 3)) /**< I2C bus busy */
#define BK_ERR_I2C_ACK_TIMEOUT           ((int)(BK_ERR_I2C_BASE - 4)) /**< I2C receive ack timeout */
#define BK_ERR_I2C_CHECK_DEFCONFIG       ((int)(BK_ERR_I2C_BASE - 5)) /**< I2C please check defconfig */
#define BK_ERR_I2C_SCL_TIMEOUT           ((int)(BK_ERR_I2C_BASE - 6)) /**< I2C SCL timeout */
