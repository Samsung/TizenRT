...
/**
 * @brief     pause i2s channel
 *
 * This API pause i2s channel to send or receive data
 *
 * @param chl i2s channel
 * @param txrx_type Tx or Rx
 *
 * @return
 *    - BK_OK: succeed
 *    - BK_ERR_AUD_NOT_INIT: i2s driver is not init
...
/**
 * @brief     resume i2s channel
 *
 * This API resume i2s channel to send or receive data
 *
 * @param chl i2s channel
 * @param txrx_type Tx or Rx
 *
