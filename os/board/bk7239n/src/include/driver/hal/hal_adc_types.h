...
#define ADC_SRC_40M_CLK		40000000
...
#ifdef CONFIG_SARADC_V1P2
	ADC_SCLK_XTAL, /**< ADC source clock xtal 26M/40M */
#elif defined(CONFIG_SARADC_V1P1)
...
typedef struct {
        ...
        uint16_t steady_ctrl;   /**< ADC steady_ctrl : steady time = (steady_ctrl +1)*8 adc_clk  */
