...
typedef enum {
	QSPI_SCLK_320M = 0,     /**< QSPI source clock 320M */
	QSPI_SCLK_480M,     /**< QSPI source clock 480M */
	QSPI_SCLK_XTAL,     /**< QSPI source clock XTAL */
	QSPI_SCLK_60M,      /**< QSPI source clock 60M */
