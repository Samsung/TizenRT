...
struct uvc_streaming_control_10
{
    uint16_t bmHint;
...
#define UVC_VERSION_10 26

struct uvc_streaming_control_11
{
    uint16_t bmHint;
    uint8_t  bFormatIndex;
    uint8_t  bFrameIndex;
...
#define UVC_VERSION_11 34

struct uvc_streaming_control_15
{
    uint16_t bmHint;
    uint8_t  bFormatIndex;
    uint8_t  bFrameIndex;
...
#define UVC_DT_FRAME_H264_SIZE(n)		(25+4*(n))
