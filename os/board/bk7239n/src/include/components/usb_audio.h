...
/* Distinguish between speakers and microphones */
#define AUDIO_SUBCLASS_SPEAKER_TERMINALLINK  0x01
#define AUDIO_SUBCLASS_MIC_TERMINALLINK 0x06
...
#define AUDIO_SIZEOF_AC_SELECTOR_UNIT_DESC(ch, n) (7 + ch * n)
