...
#define SDIO_TEST_THREAD_STACK_SIZE (0x2<<10)	//Bytes
...
#define SDIO_TEST_RX_TP_PRIORITY (6)
...
#define SDIO_TEST_TP_MSG_WAIT_TIME      (1000)
#define SDIO_TEST_RX_TP_MSG_WAIT_TIME   (0)
#define SDIO_TEST_TX_LOOPCHECK_MSG_ID  (0x301)
#define SDIO_TEST_TX_TP_MSG_ID         (0x401)
#define SDIO_LOOPCHECK_BUF_SIZE (2048)
typedef struct {
	uint8_t main_case;
	uint8_t sub_case;
	uint16_t reserved;
...
typedef enum
{
	SDIO_TEST_CFG_LOG_LEVEL,
	SDIO_TEST_CFG_MAX_SUB_CASE,
}SDIO_TEST_CFG_CASE_ID_T;
/**
