...
void bk_mpu_init(void)
{
     ...
     */
    mpu_entry = mpu_entry_alloc();
	mpu_cfg.region_base = 0x08000000;
    ...
    mpu_entry = mpu_entry_alloc();
    mpu_cfg.region_base = 0x28000000;
	 ...
	 */
    mpu_entry = mpu_entry_alloc();
	mpu_cfg.region_base = 0x40000000;
	...
	mpu_entry = mpu_entry_alloc();
	mpu_cfg.region_base = 0x60000000;
	mpu_cfg.region_size = 0x7FFE0;
	mpu_cfg.xn = MPU_EXEC_ALLOW;
	mpu_cfg.ap = MPU_UN_PRIV_RW;
	mpu_cfg.sh = MPU_NON_SHAREABLE;
	...
	mpu_entry = mpu_entry_alloc();
	mpu_cfg.region_base = 0x60080000;
	mpu_cfg.region_size = 0x7FFE0;
	mpu_cfg.xn = MPU_EXEC_ALLOW;
    ...
    /* MPU region 8 qspi0 */
    mpu_entry = mpu_entry_alloc();
	mpu_cfg.region_base = 0x64000000;
    ...
    /* MPU region 8 qspi1 */
    // mpu_entry = mpu_entry_alloc();
	// mpu_cfg.region_base = 0x68000000;
	// mpu_cfg.region_size = 0x3FFFFE0;
	// mpu_cfg.xn = MPU_EXEC_NEVER;
	// mpu_cfg.ap = MPU_UN_PRIV_RW;
	// mpu_cfg.sh = MPU_NON_SHAREABLE;
    ...
    // mpu_entry = mpu_entry_alloc();
	// mpu_cfg.region_base = 0x6C000000;
	// mpu_cfg.region_size = 0x3FFFFE0;
	// mpu_cfg.xn = MPU_EXEC_NEVER;
	// mpu_cfg.ap = MPU_UN_PRIV_RW;
	// mpu_cfg.sh = MPU_NON_SHAREABLE;
