...
#define timer_hal_backup(hal, group_id, pm_backup)  timer_ll_backup((hal)->hw, group_id, pm_backup)
#define timer_hal_restore(hal, group_id, pm_backup) timer_ll_restore((hal)->hw, group_id, pm_backup)
#endif
