...
#ifdef SDMA_DEBUG
#define SDMA_TAG "sdma"
#define SDMA_LOGI(...)      BK_LOGI(SDMA_TAG, ##__VA_ARGS__)
#define SDMA_LOGW(...)      BK_LOGW(SDMA_TAG, ##__VA_ARGS__)
#define SDMA_LOGE(...)      BK_LOGE(SDMA_TAG, ##__VA_ARGS__)
#define SDMA_LOGD(...)      BK_LOGD(SDMA_TAG, ##__VA_ARGS__)
#else
#define SDMA_LOGI(...)      os_null_printf
#define SDMA_LOGW(...)      warning_prf
#endif
