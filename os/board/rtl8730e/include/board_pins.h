...
/* MACRO to print board pins info*/
#define		DEBUG_BOARD_PINS 0
...
#define		GPIO_0		{PA_23, PIN_INPUT, PullDown }
#define		GPIO_1		{PB_20, PIN_OUTPUT, PullDown }	// PB_20 is gpio pin number for LED
#define		GPIO_2		{PB_22, PIN_INPUT, PullUp }
