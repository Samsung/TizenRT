 ...
 * (In-)Security of 64-bit Block Ciphers" by Karthikeyan Bhargavan and Ga毛tan
...
//#define MBEDTLS_PLATFORM_CALLOC_MACRO      otPlatCAlloc /**< Default allocator to use, can be undefined */
//#define MBEDTLS_PLATFORM_FREE_MACRO            free /**< Default free macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_FREE_MACRO        otPlatFree /**< Default free to use, can be undefined */
