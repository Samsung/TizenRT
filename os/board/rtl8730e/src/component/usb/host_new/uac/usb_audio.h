...
#define USBH_AUDIO_DEBUG 0

#if USBH_AUDIO_DEBUG
#define USB_AUDIO_INFO(fmt, args...)     printf("\n\r[ADC]%s: " fmt, __FUNCTION__, ## args)
#define USB_AUDIO_WARN(fmt, args...)     printf("\n\r[ADC]%s: " fmt, __FUNCTION__, ## args)
#define USB_AUDIO_ERROR(fmt, args...)    printf("\n\r[ADC]%s: " fmt, __FUNCTION__, ## args)
#define USB_AUDIO_ENTER                  printf("\n\r[ADC]%s: =>\n", __FUNCTION__)
#define USB_AUDIO_EXIT                   printf("\n\r[ADC]%s: <=\n", __FUNCTION__)
#define USB_AUDIO_EXIT_ERR               printf("\n\r[ADC]%s: ERR <=\n", __FUNCTION__)
#else
#define USB_AUDIO_INFO(fmt, args...)
#define USB_AUDIO_WARN(fmt, args...)
#define USB_AUDIO_ERROR(fmt, args...)
#define USB_AUDIO_ENTER
#define USB_AUDIO_EXIT
#define USB_AUDIO_EXIT_ERR
#endif
