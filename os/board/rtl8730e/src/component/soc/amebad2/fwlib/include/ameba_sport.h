...
#define SP_MASK_RX_SPORT_COMPARE_VAL   ((u32)0x07FFFFFF << 0)          /*!<R/W 0x40  X = (rx_sport_compare_val). When counter equal X. Sport will send rx_sport_interrupt to DSP. FW should take care X={32~8191} */
 ...
 **/
typedef struct {
	__IO uint32_t SP_REG_MUX;                             /*!<  Register,  Address offset: 0x0000 */
	__IO uint32_t SP_CTRL0;                               /*!<  Register,  Address offset: 0x0004 */
	__IO uint32_t SP_CTRL1;                               /*!<  Register,  Address offset: 0x0008 */
	__IO uint32_t SP_INT_CTRL;                            /*!<  Register,  Address offset: 0x000C */
	__IO uint32_t RSVD0;                                  /*!<  Reserved,  Address offset:0x10 */
	__I  uint32_t SP_TRX_COUNTER_STATUS;                  /*!<  Register,  Address offset: 0x0014 */
	__I  uint32_t SP_ERR;                                 /*!<  Register,  Address offset: 0x0018 */
	__IO uint32_t SP_SR_TX_BCLK;                          /*!<  Register,  Address offset: 0x001C */
	__IO uint32_t SP_TX_LRCLK;                            /*!<  Register,  Address offset: 0x0020 */
	__I  uint32_t SP_FIFO_CTRL;                           /*!<  Register,  Address offset: 0x0024 */
	__IO uint32_t SP_FORMAT;                              /*!<  Register,  Address offset: 0x0028 */
	__IO uint32_t SP_RX_BCLK;                             /*!<  Register,  Address offset: 0x002C */
	__IO uint32_t SP_RX_LRCLK;                            /*!<  Register,  Address offset: 0x0030 */
	__I  uint32_t SP_DSP_COUNTER;                         /*!<  Register,  Address offset: 0x0034 */
	__IO uint32_t RSVD1;                                  /*!<  Reserved,  Address offset:0x38 */
	__IO uint32_t SP_DIRECT_CTRL0;                        /*!<  Register,  Address offset: 0x003C */
	__IO uint32_t RSVD2;                                  /*!<  Reserved,  Address offset:0x40 */
	__IO uint32_t SP_FIFO_IRQ;                            /*!<  Register,  Address offset: 0x0044 */
	__IO uint32_t SP_DIRECT_CTRL1;                        /*!<  Register,  Address offset: 0x0048 */
	__IO uint32_t SP_DIRECT_CTRL2;                        /*!<  Register,  Address offset: 0x004C */
	__IO uint32_t RSVD3;                                  /*!<  Reserved,  Address offset:0x50 */
	__IO uint32_t SP_DIRECT_CTRL3;                        /*!<  Register,  Address offset: 0x0054 */
	__IO uint32_t SP_DIRECT_CTRL4;                        /*!<  Register,  Address offset: 0x0058 */
	__IO uint32_t SP_RX_COUNTER1;                         /*!<  Register,  Address offset: 0x005C */
	__I  uint32_t SP_RX_COUNTER2;                         /*!<  Register,  Address offset: 0x0060 */
	__IO uint32_t RSVD4[487];                              /*!<  Reserved,  Address offset:0x64-0x7FC */
	__O  uint32_t SP_TX_FIFO_0_WR_ADDR;                   /*!<  Register,  Address offset: 0x0800 */
	__IO uint32_t RSVD5[31];                              /*!<  Reserved,  Address offset:0x804-0x87C */
	__I  uint32_t SP_RX_FIFO_0_RD_ADDR;                   /*!<  Register,  Address offset: 0x0880 */
	__IO uint32_t RSVD6[31];                              /*!<  Reserved,  Address offset:0x884-0x8FC */
	__O  uint32_t SP_TX_FIFO_1_WR_ADDR;                   /*!<  Register,  Address offset: 0x0900 */
	__IO uint32_t RSVD7[31];                              /*!<  Reserved,  Address offset:0x904-0x97C */
	__I  uint32_t SP_RX_FIFO_1_RD_ADDR;                   /*!<  Register,  Address offset: 0x0980 */
} AUDIO_SPORT_TypeDef;
/** @} */
/* AUTO_GEN_END */
