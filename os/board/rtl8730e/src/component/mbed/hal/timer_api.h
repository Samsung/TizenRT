...
#if defined(CONFIG_PLATFORM_AMEBALITE) && (CONFIG_PLATFORM_AMEBALITE == 1)
///@name AmebaLite Only
///@{
...
///@}
#endif //CONFIG_PLATFORM_AMEBALITE

#if defined(CONFIG_PLATFORM_AMEBADPLUS) && (CONFIG_PLATFORM_AMEBADPLUS == 1)
///@name AmebaDPlus Only
///@{
...
///@}
    ...
    || (defined(CONFIG_PLATFORM_8710C) && (CONFIG_PLATFORM_8710C == 1))	|| (defined(CONFIG_PLATFORM_8735B) && (CONFIG_PLATFORM_8735B == 1))
///@name AmebaPro AmebaPro2 and AmebaZ2 Only
///@{
...
///@}
#endif  // end of "#if defined(CONFIG_PLATFORM_8195BHP) || defined(CONFIG_PLATFORM_8195BLP) || defined(CONFIG_PLATFORM_8710C) || defined(CONFIG_PLATFORM_8735B)"
