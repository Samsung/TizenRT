...
enum {
  I2S_TX_FIFO2 = SP_TX_FIFO2,
  I2S_TX_FIFO4 = SP_TX_FIFO4,
  I2S_TX_FIFO6 = SP_TX_FIFO6,
  I2S_TX_FIFO8 = SP_TX_FIFO8,
};

enum {
  I2S_RX_FIFO2 = SP_RX_FIFO2,
  I2S_RX_FIFO4 = SP_RX_FIFO4,
  I2S_RX_FIFO6 = SP_RX_FIFO6,
  I2S_RX_FIFO8 = SP_RX_FIFO8,
};
