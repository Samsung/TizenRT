...
## File format
Use [misc / lv_templ.c](
	https: //github.com/lvgl/lvgl/blob/master/src/misc/lv_templ.c) and [misc/lv_templ.h](https://github.com/lvgl/lvgl/blob/master/src/misc/lv_templ.h)
...
### Formatting
				...
				void lv_label_set_text(lv_obj_t *label, const char *text)
		{
			...
			if (label == NULL) {
					return;    /*No bracket only if the command is inline with the if statement*/
				}
