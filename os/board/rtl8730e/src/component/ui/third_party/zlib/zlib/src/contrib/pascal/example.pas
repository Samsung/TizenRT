...
err :
	= deflateSetDictionary(c_stream, dictionary, StrLen(dictionary));
...
err :
	= inflateSetDictionary(d_stream, dictionary, StrLen(dictionary));
end;
