...
#ifndef TIZENRT_BLE_COMBO_C_
#define TIZENRT_BLE_COMBO_C_
...
ble_result rtw_ble_combo_init(trble_client_init_config* init_client, trble_server_init_config* init_server)
{ 
...
ble_result rtw_ble_combo_deinit(void)
{
