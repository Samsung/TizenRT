...
void ble_tizenrt_central_app_task_init()
{
    ...
    os_msg_queue_create(&ble_tizenrt_central_callback_queue_handle, BLE_TIZENRT_CENTRAL_MAX_NUMBER_OF_CALLBACK_MESSAGE, sizeof(T_TIZENRT_CLIENT_APP_CALLBACK_MSG));
