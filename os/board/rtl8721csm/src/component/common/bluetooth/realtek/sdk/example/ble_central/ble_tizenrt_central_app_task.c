 ...
 *                              Macros
 *============================================================================*/
#define BLE_TIZENRT_CENRTAL_APP_TASK_PRIORITY             5         /* Task priorities */
...
#define BLE_TIZENRT_CENRTAL_CALLBACK_TASK_PRIORITY             BLE_TIZENRT_CENRTAL_APP_TASK_PRIORITY  /* Task priorities */
