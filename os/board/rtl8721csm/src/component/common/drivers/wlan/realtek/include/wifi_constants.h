...
enum _WIFI_EVENT_INDICATE{
	...
	WIFI_EVENT_STA_FOURWAY_HANDSHAKE_DONE = 21,
	WIFI_EVENT_DRIVER_START = 22,
	WIFI_EVENT_DRIVER_STOP = 23,
	WIFI_EVENT_SCANNING = 24,
	WIFI_EVENT_AUTHENTICATING = 25,
	WIFI_EVENT_ASSOCIATING = 26,
	WIFI_EVENT_ASSOCIATION_DONE = 27,
	WIFI_EVENT_FOURWAY_HANDSHAKING = 28,
