...
#if defined(CONFIG_PLATFORM_TIZENRT_OS) || (CONFIG_TIZENRT_IMG3)
...
const u32 ftl_phy_page_start_addr = 0x78000;					/* The start offset of flash pages which is allocated to FTL physical map.
