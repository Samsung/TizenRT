...
#define SCB_InvalidateDCache_by_Addr arch_invalidate_dcache
#define SCB_CleanDCache arch_clean_dcache_all
#define SCB_CleanDCache_by_Addr arch_clean_dcache
#define SCB_CleanInvalidateDCache() do {arch_invalidate_dcache_all();arch_clean_dcache_all();} while(0)
#define SCB_CleanInvalidateDCache_by_Addr(addr, len) do {arch_invalidate_dcache((u32*)addr, len); arch_clean_dcache((u32*)addr, len);} while(0)
#endif
