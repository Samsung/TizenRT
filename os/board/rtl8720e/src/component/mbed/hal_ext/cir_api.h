...
/**
  ...
  * @retval none
  */
void cir_monitor_philips_rc5_format(cir_t *obj, u8 field_1bits, u8 toggle_1bits, u8 address_5bits, u8 command_6bits, cir_irq_handler irq_monitor_cb,
									void *irq_monitor_arg);
