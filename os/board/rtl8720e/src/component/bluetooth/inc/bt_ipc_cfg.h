...
#define BT_IPC_DIR_DATA_RX IPC_KM4_TO_KR4
#define BT_IPC_DIR_DATA_TX IPC_KR4_TO_KM4
#if defined(CONFIG_BT_AP)
...
#define BT_IPC_DIR_DATA_RX IPC_KR4_TO_KM4
#define BT_IPC_DIR_DATA_TX IPC_KM4_TO_KR4
#if defined(CONFIG_BT_AP)
/* configuration for AP */
#define BT_IPC_D2H_API_TRAN IPC_R2M_BT_API_TRAN
#define BT_IPC_H2D_API_TRAN IPC_M2R_BT_API_TRAN
