...
typedef enum
{
    ...
    GAP_AOX_CONNLESS_TRANSMITTER_CTE_TYPES_AOD_1US = 0x01,  /**< AoD Constant Tone Extension with 1 ¦Ìs slots. */
    GAP_AOX_CONNLESS_TRANSMITTER_CTE_TYPES_AOD_2US = 0x02,  /**< AoD Constant Tone Extension with 2 ¦Ìs slots. */
 ...
 * @param[in]   cte_length                 Constant Tone Extension length in 8 ¦Ìs units.
