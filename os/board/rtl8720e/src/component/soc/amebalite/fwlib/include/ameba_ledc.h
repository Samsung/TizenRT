...
typedef struct {
	...
	__IO uint32_t LEDC_DUMMY_F0;                          /*!<  Register,  Address offset: 0xF0 */
	__IO uint32_t LEDC_DUMMY_F4;                          /*!<  Register,  Address offset: 0xF4 */
} LEDC_TypeDef;
/** @} */
/* AUTO_GEN_END */
