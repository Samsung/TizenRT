...
enum KR4IRQn {
	...
	/******  Specific Interrupt Numbers ************/
	WIFI_FISR_FESR_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 0,
	WIFI_FTSR_MAILBOX_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 1,
	WL_DMA_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 2,
	WL_PROTOCOL_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 3,
	BT_SCB_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 4,
	NP_WAKE_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 5,
	DSP_WAKE_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 6,
	BT_WAKE_HOST_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 7,
	RXI300_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 8,
	SYS_ILLEGAL_WRITE_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 9,
	IPC_KR4_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 10,
	IWDG0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 11,
	KM4_NS_WDG_RST_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 12,
	KM4_S_WDG_RST_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 13,
	KR4_WDG_INT_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 14,
	DSP_WDG_RST_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 15,
	TIMER0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 16,
	TIMER1_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 17,
	TIMER2_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 18,
	TIMER3_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 19,
	TIMER4_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 20,
	TIMER5_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 21,
	TIMER6_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 22,
	TIMER7_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 23,
	TIMER8_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 24,
	TIMER9_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 25,
	TIMER10_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 26,
	TIMER11_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 27,
	TIMER12_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 28,
	TIMER13_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 29,
	TIMER14_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 30,
	UART0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 31,
	UART1_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 32,
	UART2_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 33,
	UART3_BT_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 34,
	UART_LOG_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 35,
	GPIOA_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 36,
	GPIOB_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 37,
	I2C0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 38,
	I2C1_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 39,
	CTOUCH_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 40,
	GDMA0_CHANNEL0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 41,
	GDMA0_CHANNEL1_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 42,
	GDMA0_CHANNEL2_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 43,
	GDMA0_CHANNEL3_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 44,
	GDMA0_CHANNEL4_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 45,
	GDMA0_CHANNEL5_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 46,
	GDMA0_CHANNEL6_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 47,
	GDMA0_CHANNEL7_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 48,
	SPI0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 49,
	SPI1_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 50,
	SPORT0_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 51,
	SPORT1_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 52,
	RTC_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 53,
	ADC_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 54,
	ADC_COMP_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 55,
	BOR_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 56,
	PWR_DOWN_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 57,
	SPI_FLASH_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 58,
	THERMAL_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 59,
	RSIP_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 60,
	AES_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 61,
	SHA_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 62,
	ECDSA_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 63,
	PSRAMC_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 64,
	TRNG_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 65,
	LEDC_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 66,
	AES_S_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 67,
	SHA_S_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 68,
	AON_TIM_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 69,
	AON_WAKEPIN_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 70,
	DSP_ERROR_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 71,
	DSP_FATAL_ERROR_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 72,
	VAD_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 73,
	ZIGBEE_IRQ_KR4			= NVIC_PLIC_IRQ_OFFSET_1BASED + 74,
};
/**
  * @}
  */
