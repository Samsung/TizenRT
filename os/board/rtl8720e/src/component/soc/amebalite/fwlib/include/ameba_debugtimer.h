 ...
 * @{
 **/
#define DBGT_MASK_CRV            ((u32)0xFFFFFFFF << 0)          /*!<R/WOP 0h  Continuing to count from 0 once it's reached 32'hFFFFFFFF */
...
typedef struct {
	...
	__IO uint32_t DBGT_DBGTIM_DUMMY;                      /*!< DEBUG TIMERDUMMY REGISTER,  Address offset: 0x014 */
} DEBUGTIMER_TypeDef;
/** @} */
/* AUTO_GEN_END */
