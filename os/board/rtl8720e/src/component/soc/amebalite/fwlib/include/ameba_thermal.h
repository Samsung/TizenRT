 ...
 * @{
 **/
#define TM_MASK_PWR               ((u32)0x000000FF << 24)          /*!<R/W 0x0  thm protect password. tm_pow,tm_powcut,tm_rstb,tm_highcmp_pt_en,tm_high_pt_thr, iso_thm can be programed only when this value is 8'h69. */
#define TM_PWR(x)                 ((u32)(((x) & 0x000000FF) << 24))
#define TM_GET_PWR(x)             ((u32)(((x >> 24) & 0x000000FF)))
#define TM_BIT_POW                ((u32)0x00000001 << 21)          /*!<R/W 0x0  thermal poweron signal * 0:power down * 1:power on */
#define TM_BIT_POWCUT             ((u32)0x00000001 << 20)          /*!<R/W 0x0  Power cut * 0: disable power cut * 1: enable power cut */
...
#define TM_BIT_RSTB               ((u32)0x00000001 << 18)          /*!<R/W 0x0  Thermal reset signal. * 0: disable thermal * 1: enable thermal */
 ...
 * @{
 **/
#define TM_BIT_ISO_THM            ((u32)0x00000001 << 30)          /*!<R/W 0x1  1: ISO signals from thermal power domain 0: Release */
