...
void rtw_btc_ex_dbg_control(struct btc_coexist *btc, u8 op_code, u8 op_len,
							u8 *pdata);
void rtw_btc_ex_query_bt_info(struct btc_coexist *btc);
void rtw_btc_ex_gnt_debug(struct btc_coexist *btc, u8 isenable);
#else
...
#define rtw_btc_ex_query_bt_info(btc)
#define rtw_btc_ex_gnt_debug(btc, isenable)
