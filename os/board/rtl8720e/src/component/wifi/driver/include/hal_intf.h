...
struct hal_ops {
	...
	void (*stop_tx_beacon)(_adapter *padapter);
	void (*resume_tx_beacon)(_adapter *padapter);
...
#define IS_HARDWARE_TYPE_8735B(_Adapter)		(((_adapter *)_Adapter)->HardwareType == HARDWARE_TYPE_RTL8735B)
...
#elif defined(CONFIG_RTL8735B)
void rtl8735b_set_hal_ops(PADAPTER);
u8 rtl8735ba_set_hal_ops(PADAPTER);
...
#ifdef CONFIG_DFS_MASTER
void rtw_hal_stop_tx_beacon(_adapter *padapter);
void rtw_hal_resume_tx_beacon(_adapter *padapter);
#endif /* CONFIG_DFS_MASTER */
