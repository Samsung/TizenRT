...
void binary_manager_clear_bindata(int bin_idx)
{
	...
	/* If a 'reload' flag is true, a binary manager uses loading data, bininfo when loading the binary later.
	 * So clear BIN_LOADINFO which points loading data if a flag is false.
	 */
