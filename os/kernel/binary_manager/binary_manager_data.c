...
static binmgr_bininfo_t bin_table[USER_BIN_COUNT];
static uint32_t g_bin_count;

/* Data for Kernel partitions */
static binmgr_kerinfo_t kernel_info;
...
/****************************************************************************
 * Name: binary_manager_get_kernel_part_count
 *
 * Description:
...
/****************************************************************************
 * Name: binary_manager_get_kernel_data
 *
 * Description:
