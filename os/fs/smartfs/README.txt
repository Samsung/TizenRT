...
========
  ...
  The FS includes support for:
    ...
    - Recovery corrupted sector & Logging based Journaling
...
=================
  ...
  layers:
    ...
    1.  The MTD block layer (os/drivers/mtd/smart.c).  This layer manages
    ...
    2.  The FS layer (os/fs/smart/smartfs_smart.c).  This layer manages
  ...
  use, including
    ...
    Sector 12:    Reserved
    Sector 13-x : Logging data of Journaling. X can be configurable.
...
2. The released-sector garbage collection process occurs only during a write
...
3. The total number of logical sectors on the device must be 65534 or less.
