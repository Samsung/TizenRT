 ...
 *   CONFIG_HID_STATEDEPTH in the config file.
 *
 ...
 *   overridden by defining CONFIG_HID_MAXCOLLECTIONS in the config file.
 *
 * CONFIG_HID_MAXITEMS
 ...
 *   CONFIG_HID_MAXITEMS in the config file.
 *
 * CONFIG_HID_MAXIDS
 ...
 *   CONFIG_HID_MAXIDS in the config file. Note that IN, OUT and FEATURE
