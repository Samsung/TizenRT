...
#ifndef __INCLUDE_TINYARA_USB_HID_PARSER_H
#define __INCLUDE_TINYARA_USB_HID_PARSER_H
 ...
 *   CONFIG_HID_STATEDEPTH in the TinyAra config file.
 *
 ...
 *   overridden by defining CONFIG_HID_MAXCOLLECTIONS in the TinyAra config file.
 *
 * CONFIG_HID_MAXITEMS
 ...
 *   CONFIG_HID_MAXITEMS in the TinyAra config file.
 *
 * CONFIG_HID_MAXIDS
 ...
 *   CONFIG_HID_MAXIDS in the TinyAra config file. Note that IN, OUT and FEATURE
...
#endif							/* __INCLUDE_TINYARA_USB_HID_PARSER_H */
