...
typedef volatile unsigned int   vbool;
...
////////////////////////////////////////
s32 IST415x_Ctrl_HW_Reset(void);
s32 IST415x_Ctrl_SW_Reset(void);

s32 IST415x_Ctrl_SenseOn(u32 On);
s32 IST415x_Ctrl_AutoCalibration(void);
s32 IST415x_Ctrl_SetJigMode(u8 Mode);

////////////////////////////////////////
// Test Function
////////////////////////////////////////
s32 IST415x_Read_TSPInfo(void);
s32 IST415x_Test_CM(u16 *pCmData, u8 cnt);
s32 IST415x_Test_Jitter(u16 *pJitterData, u8 cnt);
s32 IST415x_Calibration(u32 *pResult, u8 resultSize, u32 timeout);
s32 IST415x_Test_CR(u32 *pCrResult, u32 *pSelfCrResult);
void IST415x_Ctrl_InitTouchTest(void);
s32	IST415x_Ctrl_ReadTouchData(void);
