...
typedef trble_result_e (*trble_delete_bond)(struct netdev *dev, trble_bd_addr *addr);
typedef trble_result_e (*trble_delete_bond_all)(struct netdev *dev);
...
typedef trble_result_e (*trble_conn_is_active)(struct netdev *dev, bool *is_active);
