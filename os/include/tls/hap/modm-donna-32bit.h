...
static void expand256_modm(bignum256modm out, const unsigned char *in, uint32_t len)
{
...
static void sub256_modm_batch(bignum256modm out, const bignum256modm a, const bignum256modm b, uint32_t limbsize)
{
	uint32_t i = 0;
...
/* is a < b */
static int lt256_modm_batch(const bignum256modm a, const bignum256modm b, uint32_t limbsize)
{
	switch (limbsize) {
	case 8:
		if (a[8] > b[8]) {
...
/* is a <= b */
static int lte256_modm_batch(const bignum256modm a, const bignum256modm b, uint32_t limbsize)
{
	switch (limbsize) {
	case 8:
		if (a[8] > b[8]) {
