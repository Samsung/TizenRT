...
static void curve25519_recip(bignum25519 out, const bignum25519 z)
{
	...
	/* 2 */ curve25519_square_times(a, z, 1);
	/* a = 2 */
	/* 8 */ curve25519_square_times(t0, a, 2);
	/* 9 */ curve25519_mul_noinline(b, t0, z);
	/* b = 9 */
	/* 11 */ curve25519_mul_noinline(a, b, a);
	/* a = 11 */
...
static void curve25519_pow_two252m3(bignum25519 two252m3, const bignum25519 z)
{
	...
	/* 2 */ curve25519_square_times(c, z, 1);
	/* c = 2 */
	/* 8 */ curve25519_square_times(t0, c, 2);
	/* t0 = 8 */
	/* 9 */ curve25519_mul_noinline(b, t0, z);
	/* b = 9 */
	/* 11 */ curve25519_mul_noinline(c, b, c);
	/* c = 11 */
