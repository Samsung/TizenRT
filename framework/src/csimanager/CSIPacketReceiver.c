...
CSIFW_RES csi_packet_receiver_stop_collect(int disableCSI)
{
...
CSIFW_RES csi_packet_receiver_deinit(void)
{
	...
	CSIFW_LOGD("CSI packet receiver successfully deinitialized (callback: %p)", 
		p_csifw_ctx->CSI_DataCallback);
	return CSIFW_OK;
}
