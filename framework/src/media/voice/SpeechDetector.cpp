...
speech_detect_event_type_e SpeechDetectorImpl::getSpeechDetectEvent(audio_device_process_unit_subtype_e event)
{
	...
	case AUDIO_DEVICE_SPEECH_DETECT_LOCAL8:
		return SPEECH_DETECT_LOCAL8;
	case AUDIO_DEVICE_SPEECH_DETECT_LOCAL9:
		return SPEECH_DETECT_LOCAL9;
	case AUDIO_DEVICE_SPEECH_DETECT_LOCAL10:
		return SPEECH_DETECT_LOCAL10;
	case AUDIO_DEVICE_SPEECH_DETECT_LOCAL11:
		return SPEECH_DETECT_LOCAL11;
	case AUDIO_DEVICE_SPEECH_DETECT_LOCAL12:
		return SPEECH_DETECT_LOCAL12;
	case AUDIO_DEVICE_SPEECH_DETECT_LOCAL13:
		return SPEECH_DETECT_LOCAL13;
	default:
		return SPEECH_DETECT_NONE;
	}
}
