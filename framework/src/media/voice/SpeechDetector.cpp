...
speech_detect_event_type_e SpeechDetectorImpl::getSpeechDetectEvent(audio_device_process_unit_subtype_e event)
{
	...
	case AUDIO_DEVICE_SPEECH_DETECT_SNORING:
		return SPEECH_DETECT_SNORING;
	case AUDIO_DEVICE_SPEECH_DETECT_BABYCRY:
		return SPEECH_DETECT_BABYCRY;
	case AUDIO_DEVICE_SPEECH_DETECT_DOG:
		return SPEECH_DETECT_DOG;
	case AUDIO_DEVICE_SPEECH_DETECT_COUGH:
		return SPEECH_DETECT_COUGH;
	case AUDIO_DEVICE_SPEECH_DETECT_CLAP:
		return SPEECH_DETECT_CLAP;
	default:
		return SPEECH_DETECT_NONE;
	}
}
