...
player_result_t MediaPlayerImpl::create()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling createPlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::createPlayer(player_result_t &ret, sem_t &syncSem)
{
...
player_result_t MediaPlayerImpl::destroy()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling destroyPlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::unsetPlayerObserver(sem_t &syncSem)
{
	mPlayerObserver = nullptr;
	notifySync(syncSem);
}

void MediaPlayerImpl::destroyPlayer(player_result_t &ret, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
player_result_t MediaPlayerImpl::prepare()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling preparePlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::preparePlayer(player_result_t &ret, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
player_result_t MediaPlayerImpl::unprepare()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling unpreparePlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::unpreparePlayer(player_result_t &ret, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
player_result_t MediaPlayerImpl::start()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling startPlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::startPlayer(player_result_t &ret, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
player_result_t MediaPlayerImpl::stop()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling stopPlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::stopPlayer(player_result_t &ret, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
player_result_t MediaPlayerImpl::pause()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling pausePlayer directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::pausePlayer(player_result_t &ret, bool notify, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
player_result_t MediaPlayerImpl::getVolume(uint8_t *vol)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling getPlayerVolume directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::getPlayerVolume(uint8_t *vol, player_result_t &ret, sem_t &syncSem)
{
...
player_result_t MediaPlayerImpl::getMaxVolume(uint8_t *vol)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling getPlayerMaxVolume directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::getPlayerMaxVolume(uint8_t *vol, player_result_t &ret, sem_t &syncSem)
{
...
player_result_t MediaPlayerImpl::setVolume(uint8_t vol)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling setPlayerVolume directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::setPlayerVolume(uint8_t vol, player_result_t &ret, sem_t &syncSem)
{
...
player_result_t MediaPlayerImpl::setDataSource(std::unique_ptr<stream::InputDataSource> source)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling setPlayerDataSource directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::setPlayerDataSource(std::shared_ptr<stream::InputDataSource> source, player_result_t &ret, sem_t &syncSem)
{
	if (mCurState != PLAYER_STATE_IDLE && mCurState != PLAYER_STATE_CONFIGURED &&
...
player_result_t MediaPlayerImpl::setObserver(std::shared_ptr<MediaPlayerObserverInterface> observer)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling setPlayerObserver directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::setPlayerObserver(std::shared_ptr<MediaPlayerObserverInterface> observer, player_result_t &ret, sem_t &syncSem)
{
...
player_result_t MediaPlayerImpl::setStreamInfo(std::shared_ptr<stream_info_t> stream_info)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling setPlayerStreamInfo directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::setPlayerStreamInfo(std::shared_ptr<stream_info_t> stream_info, player_result_t &ret, sem_t &syncSem)
{
	LOG_STATE_INFO(mCurState);
...
bool MediaPlayerImpl::isPlaying()
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, checking state directly. player: %x\n", &mPlayer);
...
player_result_t MediaPlayerImpl::setLooping(bool loop)
{
	...
	if (mpw.isSameThread()) {
		medvdbg("Already on PlayerWorker thread, calling setPlayerLooping directly. player: %x\n", &mPlayer);
...
void MediaPlayerImpl::setPlayerLooping(bool loop, player_result_t &ret, sem_t &syncSem)
{
...
void MediaPlayerImpl::notifySync(sem_t &syncSem)
{
	sem_post(&syncSem);
}
