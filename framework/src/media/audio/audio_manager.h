...
/****************************************************************************
 * Name: get_max_audio_gain
 *
 * Description:
 *   Get the maximum gain of the active input audio device.
 *
 * Input parameter:
 *   gain: the pointer to get the maximum gain value
 *
 * Return Value:
 *   AUDIO_MANAGER_SUCCESS only if the maximum gain is obtained successfully
