...
enum audio_device_process_unit_subtype_e {
	...
	AUDIO_DEVICE_SPEECH_DETECT_SNORING = 14,
	AUDIO_DEVICE_SPEECH_DETECT_BABYCRY = 15,
	AUDIO_DEVICE_SPEECH_DETECT_DOG = 16,
	AUDIO_DEVICE_SPEECH_DETECT_COUGH = 17,
	AUDIO_DEVICE_SPEECH_DETECT_CLAP = 18
};
