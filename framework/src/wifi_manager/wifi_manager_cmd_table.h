...
WIFIMGR_REQUEST_TABLE("CMD_SCAN_MULTI_APS", WIFIMGR_CMD_SCAN_MULTI_APS, "Command to perform WiFi Scanning over WLAN channels")
...
WIFIMGR_REQUEST_TABLE("CMD_SET_BRIDGE", WIFIMGR_CMD_SET_BRIDGE, "Command to control Bridge mode on/off")
#endif
WIFIMGR_REQUEST_TABLE("CMD_DISABLE_11AX_MODE", WIFIMGR_CMD_DISABLE_11AX_MODE, "Command to disable/enable 11ax mode")
