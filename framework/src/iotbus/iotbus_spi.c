...
int iotbus_spi_write(iotbus_spi_context_h hnd, uint8_t *txbuf, uint32_t length)
{
	if (!hnd)
...
int iotbus_spi_recv(iotbus_spi_context_h hnd, uint8_t *rxbuf, uint32_t length)
{
...
int iotbus_spi_transfer_buf(iotbus_spi_context_h hnd, uint8_t *txbuf, uint8_t *rxbuf, uint32_t length)
{
