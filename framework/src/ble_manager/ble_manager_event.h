...
typedef enum {
	...
	BLE_EVT_CMD_WHITELIST_ADD,
	BLE_EVT_CMD_WHITELIST_DELETE,
	BLE_EVT_CMD_WHITELIST_CLEAR_ALL,
	
	// Client
	BLE_EVT_CMD_CREATE_CTX,
	BLE_EVT_CMD_DESTROY_CTX,
	BLE_EVT_CMD_GET_CLIENT_STATE,
	BLE_EVT_CMD_CLIENT_CONNECT,
	BLE_EVT_CMD_CLIENT_RECONNECT,
	BLE_EVT_CMD_CLIENT_ENABLE_AUTOCONNECT,
	BLE_EVT_CMD_CLIENT_DISABLE_AUTOCONNECT,
	BLE_EVT_CMD_CLIENT_DISCONNECT,
	BLE_EVT_CMD_CLIENT_DISCONNECT_ALL,
