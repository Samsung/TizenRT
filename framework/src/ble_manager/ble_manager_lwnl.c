...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = {1, {(void *)is_active }};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CONN_IS_ANY_ACTIVE}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_start_scan(trble_scan_filter *filter)
{
	...
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_START_SCAN}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = {1, {(void *)out_connected_list }};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CONNECTED_DEV_LIST}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = {1, {(void *)server_config }};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_SET_SERVER_CONFIG}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = {1, {(void *)count }};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_GET_PROFILE_COUNT}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = {1, {(void *)name }};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_SET_DEVICE_NAME}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_DELETE_ADV}, sizeof(adv_handle), (void *)&adv_handle, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_set_multi_adv_data(uint8_t adv_handle, uint8_t adv_data_len, uint8_t *ext_adv_data)
{
	...
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_SET_MULTI_ADV_DATA}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_START_MULTI_ADV}, sizeof(adv_handle), (void *)&adv_handle, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_STOP_MULTI_ADV}, sizeof(adv_handle), (void *)&adv_handle, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = { 2, {(void *)&is_reg,(void *)&psm}};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_REG_PSM}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_coc_set_psm_security(uint16_t le_psm, uint8_t active, uint8_t sec_mode, uint8_t key_size)
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = { 4, {(void *)&le_psm, (void *)&active, (void *)&sec_mode, (void *)&key_size}};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_SET_PSM_SEC}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_coc_set_param(uint16_t value)
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_SET_PARAM}, sizeof(uint16_t), (void *)&value, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_coc_get_param(uint8_t param_type, uint16_t cid, uint16_t *value)
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = { 3, {(void *)&param_type, (void *)&cid, (void *)value}};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_GET_PARAM}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_coc_connect(uint16_t conn_handle, uint16_t le_psm)
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = { 2, {(void *)&conn_handle, (void *)&le_psm}};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_CONNECT}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_coc_disconnect(uint16_t cid)
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_DISCONNECT}, sizeof(uint16_t), (void *)&cid, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
...
trble_result_e ble_drv_coc_send(uint16_t is_reg, uint16_t len, uint8_t *data)
{
	trble_result_e res = TRBLE_SUCCESS;
	lwnl_msg_params msg_data = { 3, {(void *)&is_reg, (void *)&len, (void *)data}};
	lwnl_msg msg = {BLE_INTF_NAME, {LWNL_REQ_BLE_CMD_COC_SEND}, sizeof(msg_data), (void *)&msg_data, (void *)&res};
	if (_send_msg(&msg) < 0) {
		res = TRBLE_FILE_ERROR;
	}
	return res;
