...
ble_result_e ble_coc_set_param(uint8_t param_type, uint16_t value)
{
	blemgr_msg_params param = { 2, {(void *)&param_type, (void *)&value}};
	blemgr_msg_s msg = {BLE_CMD_COC_SET_PARAM, BLE_MANAGER_FAIL, (void *)(&param), NULL};
	int res = blemgr_post_message(&msg);
