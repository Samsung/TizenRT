...
static const thread_info_s things_stack_thread_name[THINGS_STACK_MAX_INDEX] = {
	{"THINGS_STACK_PING", 3 * 1024},                 /*THINGS_STACK_PING_THREAD */
	{"THINGS_STACK_RESET", 3 * 1024},                /*THINGS_STACK_RESETLOOP_THREAD */
	{"THINGS_STACK_CLOUD_CONNECT", 2 * 1024},        /*THINGS_STACK_CICONNETION_INIT_THREAD */
	{"THINGS_STACK_CICONN_WAIT", 4 * 1024},          /*THINGS_STACK_CICONNETION_WAIT_THREAD */
	{"THINGS_STACK_CLOUD_TOKEN_CHECK", 4 * 1024},    /*THINGS_STACK_CLOUD_TOKEN_CHECK_THREAD */
	{"THINGS_STACK_PRESENCE_NOTI_THREAD", 2 * 1024}, /*THINGS_STACK_PRESENCE_NOTI_THREAD */
	{"THINGS_STACK_SERVEREXCE_LOOP", 4 * 1024},      /*THINGS_STACK_SERVEREXCETUE_LOOP_THREAD */
	{"THINGS_STACK_TIME_OUT", 2 * 1024},             /*THINGS_STACK_TIME_OUT_THREAD */
	{"THINGS_STACK_ABORT", 2 * 1024},                /*THINGS_STACK_ABORT_THREAD */
	{"THINGS_STACK_WIFI_JOIN", 2 * 1024},            /*THINGS_STACK_WIFI_JOIN_THREAD */
	{"THINGS_STACK_FOTA_UPDATE", 6 * 1024},          /*THINGS_STACK_FOTA_THREAD */
	{"THINGS_STACK_AP_INFO_SET", 2 * 1024},          /*THINGS_STACK_AP_INFO_SET_THREAD */
	{"THINGS_STACK_MAX_INDEX", 2 * 1024}             /*THINGS_STACK_MAX_INDEX */
};
