...
typedef int (*things_reset_confirm_func_type)(things_reset_result_func_type *func_carrier, es_enrollee_reset_e reset_type);
...
int things_reset(void *remote_owner, es_enrollee_reset_e reset_type);

int things_stop(void);

typedef int (*things_handle_request_func_type)(struct oic_resource_s *pResource);
int things_register_handle_request_func(things_handle_request_func_type get_func, things_handle_request_func_type set_func);	// jun
...
typedef void (*things_get_easysetup_state_func_type)(es_enrollee_state_e state);
...
typedef void (*things_abort_easysetup_func_type)(es_enrollee_abort_e level);
