...
#define SDKAPI_ST_THINGS_TAG "ST_THINGS_SDK"
...
#define SDKAPI_LOG(level, logStr) dlog_print(level, SDKAPI_ST_THINGS_TAG, "%s : %s(%d) > " logStr, __FILE__, __FUNCTION__, __LINE__)
#define SDKAPI_LOG_V(level, fmt, ...) dlog_print(level, SDKAPI_ST_THINGS_TAG, "%s : %s(%d) > " fmt, __FILE__, __FUNCTION__, __LINE__, __VA_ARGS__)
#define SDKAPI_LOG_ENTRY(level) dlog_print(level, SDKAPI_ST_THINGS_TAG, "%s : %s(%d) > " SDKAPI_FUNC_ENTRY, __FILE__, __FUNCTION__, __LINE__)
#define SDKAPI_LOG_EXIT(level) dlog_print(level, SDKAPI_ST_THINGS_TAG, "%s : %s(%d) > " SDKAPI_FUNC_EXIT, __FILE__, __FUNCTION__, __LINE__)
#else							/* Linux */
#define SDKAPI_LOG_INIT()   SDKAPI_LogInit()
#define SDKAPI_LOG_DEINIT()   SDKAPI_LogShutdown()
#define SDKAPI_LOG(level, logStr)  SDKAPI_Log((level), SDKAPI_ST_THINGS_TAG, __FUNCTION__, __LINE__, (logStr))
#define SDKAPI_LOG_V(level, fmt, ...)   SDKAPI_LogV((level), SDKAPI_ST_THINGS_TAG, __FUNCTION__, __LINE__, fmt, __VA_ARGS__)
#define SDKAPI_LOG_ENTRY(level) SDKAPI_Log((level), SDKAPI_ST_THINGS_TAG, __FUNCTION__, __LINE__, (SDKAPI_FUNC_ENTRY))
#define SDKAPI_LOG_EXIT(level) SDKAPI_Log((level), SDKAPI_ST_THINGS_TAG, __FUNCTION__, __LINE__, (SDKAPI_FUNC_EXIT))
#endif
