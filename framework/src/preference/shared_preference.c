...
int preference_shared_is_existing(const char *key, bool *existing)
{
	...
	return prctl(PR_CHECK_PREFERENCE, SHARED_PREFERENCE, key, existing);
}
...
int preference_shared_remove(const char *key)
{
	...
	return prctl(PR_REMOVE_PREFERENCE, SHARED_PREFERENCE, key);
}
...
int preference_shared_remove_all(char *path)
{
	...
	/* Remove preference with prctl */
	return prctl(PR_REMOVEALL_PREFERENCE, SHARED_PREFERENCE, path);
}

/****************************************************************************
 * Callback Functions
 ****************************************************************************/
int preference_shared_set_changed_cb(const char *key, preference_changed_cb callback, void *user_data)
{
	int ret;
...
int preference_shared_unset_changed_cb(const char *key)
{
	...
	return prctl(PR_UNSET_PREFERENCE_CB, SHARED_PREFERENCE, key);
}
