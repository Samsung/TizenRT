...
int auth_get_ecdsa_signature(security_handle hnd, security_ecdsa_mode mode, const char *key_name, security_data *hash, security_data *sign);

int auth_verify_ecdsa_signature(security_handle hnd, security_ecdsa_mode mode, const char *key_name, security_data *hash, security_data *sign);
...
int auth_generate_dhparams(security_handle hnd, security_dh_param *params, security_data *pub);

int auth_set_dhparams(security_handle hnd, security_dh_param *params, security_data *pub);

int auth_compute_dhparams(security_handle hnd, security_dh_param *params, security_data *secret);

int auth_generate_ecdhkey(security_handle hnd, security_ecdh_param *params, security_data *pub);

int auth_compute_ecdhkey(security_handle hnd, security_ecdh_param *params, security_data *secret);
