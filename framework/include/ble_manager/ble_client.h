...
typedef void (*ble_client_passkey_display_cb)(ble_client_ctx *ctx, uint32_t passkey, ble_conn_handle con_handle);
typedef void (*ble_client_pair_bond_cb)(ble_client_ctx *ctx, uint32_t pair_bond_result, ble_conn_handle con_handle);
...
typedef struct {
	...
	ble_client_pair_bond_cb pair_bond_cb;
