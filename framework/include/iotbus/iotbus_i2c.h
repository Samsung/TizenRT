 ...
 * @since Tizen RT v1.0
 */
int iotbus_i2c_read(iotbus_i2c_context_h hnd, uint8_t *data, uint32_t length);
 ...
 * @since Tizen RT v1.0
 */
int iotbus_i2c_write(iotbus_i2c_context_h hnd, const uint8_t *data, uint32_t length);
