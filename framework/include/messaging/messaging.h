...
typedef enum msg_type_e msg_type_t;
 ...
 */
typedef void (*msg_callback_t)(int msg_type, msg_recv_buf_t *recv_data, void *cb_data);
 ...
 *		  msglen       : The length of message to be sent.\n
 *		  priority     : A non-negative integer that specifies the priority of this message.
 * @return On success, the number of receivers is returned. On failure, ERROR is returned.
 * @since TizenRT v3.0
 */
int messaging_multicast_send(const char *port_name, msg_send_data_t *send_data);
