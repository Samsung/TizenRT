...
/**
 * @brief Set the pivot point of image asset.
 *
 * The coordinates of the pivot point are relative coordinates to the anchor point.
 * The image asset will be drawn on the screen based on the pivot point.
...
/**
 * @brief Measures the actual width of the text (in pixels) when the specified font is used.
 *
 * @param[in] font Handle of the font asset
 * @param[in] text String of text
 * @return On success, the width of the text string is returned. On failure, 0 is returned.
 *
 * @see ui_font_asset_create()
 */
