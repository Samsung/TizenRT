...
/**
 * @brief Set the global widget to the certain event type.
 *
 * @param[in] event_type Type of the event to which the global widget will be set.
 * @param[in] widget Handle of the global widget.
 * @return On success, UI_OK is returned. On failure, the defined error type is returned.
 *
 * @see ui_global_widget_event_type_t
 */
 ...
 * @brief Stop the UI Core Service.
 *
 * @param[in] event_type Event type of the global widget which want to unset
 * @return On success, UI_OK is returned. On failure, the defined error type is returned.
 *
 * @see ui_global_widget_event_type_t
 */
 ...
 * @brief Stop the UI Core Service.
 *
 * @param[in] event_type Event type of the global widget which want to appear
 * @return On success, UI_OK is returned. On failure, the defined error type is returned.
 *
 * @see ui_global_widget_event_type_t
 */
 ...
 * @brief Stop the UI Core Service.
 *
 * @param[in] event_type Event type of the global widget which want to disappear
 * @return On success, UI_OK is returned. On failure, the defined error type is returned.
 *
 * @see ui_global_widget_event_type_t
 */
