...
Unified coding style make it easy to maintain the TizenRT. The platform developers should follow the coding styles described in this document. The preffered style is BSD/Allman. **[Mxx]** : Mandatory **[Rxx]** : Recommend
...
```
**[R13]** Names of macros defining constants and lables in enums are composed of capital letters, numbers and '_' character.
...
**[M01]**The guard symbol format shoud be __<PROJECT>_<FILE>_H__.
